...
import com.kelco.kamenridercraft.client.model.base_model.BaseEffectModel;
...
public class BaseEffectRenderer extends GeoEntityRenderer<BaseEffectEntity> {
    ...
    public void render(BaseEffectEntity entity, float entityYaw, float partialTick, PoseStack poseStack,
    ...
    @Override
    public RenderType getRenderType(BaseEffectEntity animatable, ResourceLocation texture,
