...
import com.kelco.kamenridercraft.entity.mobs.foot_soldiers.ReaperlegionEntity;
import com.kelco.kamenridercraft.entity.mobs.foot_soldiers.variants.ReaperVariant;
...
public class ReaperRenderer extends HumanoidMobRenderer<ReaperlegionEntity, BasicMobModel<ReaperlegionEntity>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(ReaperlegionEntity reaperlegionEntity) {
        return LOCATION_BY_VARIANT.get(reaperlegionEntity.getVariant());
    }
}