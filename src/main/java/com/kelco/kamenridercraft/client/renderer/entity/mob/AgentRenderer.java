...
public class AgentRenderer extends HumanoidMobRenderer<AgentEntity, BasicMobModel<AgentEntity>> {
    private static final Map<AgentVariant, ResourceLocation> LOCATION_BY_VARIANT =
            Util.make(Maps.newEnumMap(AgentVariant.class), map -> {
                ...
                map.put(AgentVariant.RED_A,
                        ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID, "textures/entities/agent_red_a.png"));
                map.put(AgentVariant.RED_B,
                        ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID, "textures/entities/agent_red_b.png"));
            });
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(AgentEntity agentEntity) {
        return LOCATION_BY_VARIANT.get(agentEntity.getVariant());
    }
}