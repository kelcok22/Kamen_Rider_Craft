...
public class ElementaryInvesRenderer extends HumanoidMobRenderer<ElementaryInvesRedEntity, ElementaryInvesModel<ElementaryInvesRedEntity>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(ElementaryInvesRedEntity elementaryInvesRedEntity) {
        return LOCATION_BY_VARIANT.get(elementaryInvesRedEntity.getVariant());
    }
}