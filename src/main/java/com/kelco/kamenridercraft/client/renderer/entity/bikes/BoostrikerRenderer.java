    ...
    public BoostrikerRenderer(EntityRendererProvider.Context renderManager) {
        ...
        addRenderLayer(new GeoRenderLayer<>(this) {
            ...
            protected ResourceLocation getTextureResource(BoostrikerEntity animatable) {
                return ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID, "textures/entity/boostriker/logo_"
                        + animatable.getRiderLogo() + ".png");
            }

            @Override
            public void render(PoseStack poseStack, BoostrikerEntity animatable, BakedGeoModel bakedModel,
