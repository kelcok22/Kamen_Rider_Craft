...
import com.kelco.kamenridercraft.entity.mobs.foot_soldiers.variants.MalgamVariant;
...
public class MalgamRenderer extends HumanoidMobRenderer<MalgamEntity, BasicMobModel<MalgamEntity>> {
    ...
    @Override
    public @NotNull ResourceLocation getTextureLocation(MalgamEntity malgamEntity) {
        return LOCATION_BY_VARIANT.get(malgamEntity.getVariant());
    }
}