...
public class MidaredoujiModel<T extends Mob> extends BasicMobModel<T> {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body = partdefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 16).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
		body.addOrReplaceChild("wings", CubeListBuilder.create().texOffs(0, 64).addBox(-12.0F, -3.0F, 2.25F, 24.0F, 9.0F, 0.0F, new CubeDeformation(0.0F)), PartPose.ZERO);
