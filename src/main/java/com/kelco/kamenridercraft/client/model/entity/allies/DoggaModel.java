...
public class DoggaModel<T extends Mob> extends BasicMobModel<T> {
    ...
    public DoggaModel(ModelPart modelPart) {
        super(modelPart);
    }
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        partdefinition.addOrReplaceChild("left_sleeve", CubeListBuilder.create().texOffs(32, 48)
                .addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F))
                .texOffs(48, 48).addBox(-1.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F,
                        new CubeDeformation(1.0F)), PartPose.offset(2.0F, 0.0F, 0.0F));
        partdefinition.addOrReplaceChild("right_sleeve", CubeListBuilder.create().texOffs(40, 32)
                ...
                .texOffs(40, 16).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F,
                        new CubeDeformation(0.5F)), PartPose.offset(-1.0F, 0.0F, 0.0F));
        ...
        partdefinition.addOrReplaceChild("left_pants", CubeListBuilder.create().texOffs(16, 48)
                .addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F))
                .texOffs(0, 48).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F,
                        new CubeDeformation(1.0F)), PartPose.offset(0.0F, 1.0F, 0.0F));
        partdefinition.addOrReplaceChild("right_pants", CubeListBuilder.create().texOffs(0, 16)
                .addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.5F))
                .texOffs(0, 32).addBox(-2.0F, 0.0F, -2.0F, 4.0F, 12.0F, 4.0F,
                        new CubeDeformation(1.0F)), PartPose.offset(0.0F, 1.0F, 0.0F));
        partdefinition.addOrReplaceChild("jacket", CubeListBuilder.create().texOffs(16, 16)
                .addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F, new CubeDeformation(0.5F))
                .texOffs(16, 32).addBox(-4.0F, 0.0F, -2.0F, 8.0F, 12.0F, 4.0F,
                        new CubeDeformation(1.0F))
                .texOffs(0, 64).addBox(-12.0F, -3.0F, -4.0F, 8.0F, 8.0F, 8.0F,
                        new CubeDeformation(0.0F))
                .texOffs(0, 64).mirror().addBox(4.0F, -3.0F, -4.0F, 8.0F, 8.0F, 8.0F,
                        new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 0.0F, 0.0F));

        addHead(meshdefinition);
        partdefinition.addOrReplaceChild("hat", CubeListBuilder.create().texOffs(0, 0)
