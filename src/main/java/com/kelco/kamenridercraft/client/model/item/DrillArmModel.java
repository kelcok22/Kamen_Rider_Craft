package com.kelco.kamenridercraft.client.model.item;
...
public class DrillArmModel extends GeoModel<DrillArmItem> {
    ...
    public ResourceLocation getModelResource(DrillArmItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID, "geo/item/drill_arm.geo.json");
    }
