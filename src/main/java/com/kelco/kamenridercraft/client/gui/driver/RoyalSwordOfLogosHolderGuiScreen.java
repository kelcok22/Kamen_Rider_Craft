...
@OnlyIn(Dist.CLIENT)
public class RoyalSwordOfLogosHolderGuiScreen extends AbstractContainerScreen<RoyalSwordOfLogosHolderGuiMenu> {
    ...
    public RoyalSwordOfLogosHolderGuiScreen(RoyalSwordOfLogosHolderGuiMenu menu, Inventory playerInventory, Component title) {
