...
public class RiderGashatCaseGuiScreen extends AbstractContainerScreen<RiderGashatCaseGuiMenu> {
	private static final ResourceLocation CONTAINER_TEXTURE = ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID,"textures/gui/container/rider_gashat_case_gui.png");
