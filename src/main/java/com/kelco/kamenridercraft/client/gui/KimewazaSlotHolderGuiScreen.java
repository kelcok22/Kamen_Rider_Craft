...
public class KimewazaSlotHolderGuiScreen extends AbstractContainerScreen<KimewazaSlotHolderGuiMenu> {
	private static final ResourceLocation CONTAINER_TEXTURE = ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID,"textures/gui/container/kimewaza_slot_holder_gui.png");
