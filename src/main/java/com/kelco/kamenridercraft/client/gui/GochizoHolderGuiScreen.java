...
@OnlyIn(Dist.CLIENT)
public class GochizoHolderGuiScreen extends AbstractContainerScreen<GochizoHolderGuiMenu> {
	...
	public GochizoHolderGuiScreen(GochizoHolderGuiMenu menu, Inventory playerInventory, Component title) {
