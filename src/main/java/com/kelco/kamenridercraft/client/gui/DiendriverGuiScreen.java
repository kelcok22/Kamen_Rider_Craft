...
public class DiendriverGuiScreen extends AbstractContainerScreen<DiendriverGuiMenu> {
	private static final ResourceLocation CONTAINER_TEXTURE = ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID,"textures/gui/container/diendriver_gui.png");
