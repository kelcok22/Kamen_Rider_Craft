...
public class AdventDeckGuiScreen extends AbstractContainerScreen<AdventDeckGuiMenu> {
	private final static HashMap<String, Object> guistate = AdventDeckGuiMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AdventDeckGuiScreen(AdventDeckGuiMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = ResourceLocation.parse("kamenridercraft:textures/screens/advent_deck_gui.png");
