...
@OnlyIn(Dist.CLIENT)
public class OMedalNestGuiScreen extends AbstractContainerScreen<OMedalNestGuiMenu> {
	private static final ResourceLocation CONTAINER_TEXTURE = ResourceLocation.fromNamespaceAndPath(KamenRiderCraftCore.MOD_ID,"textures/gui/container/o_medal_nest_gui.png");
