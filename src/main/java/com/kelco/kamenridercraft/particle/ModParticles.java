...
public class ModParticles {
    ...
    public static final Supplier<SimpleParticleType> MISS_PARTICLES =
            PARTICLE_TYPES.register("miss_particles", () -> new SimpleParticleType(true));
    ...
    public static final Supplier<SimpleParticleType> MARSHMALLOW_PARTICLES =
            PARTICLE_TYPES.register("marshmallow_particles", () -> new SimpleParticleType(true));
    ...
    public static final Supplier<SimpleParticleType> MY_TH_GEM_TURTLE_PARTICLES =
            PARTICLE_TYPES.register("my_th_gem_turtle_particles", () -> new SimpleParticleType(true));
