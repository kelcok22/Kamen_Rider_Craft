...
public class MiridewatchHolderGuiMenu extends AbstractContainerMenu {
	...
	public MiridewatchHolderGuiMenu(int containerId, Inventory playerInventory, FriendlyByteBuf registryFriendlyByteBuf) {
		this(containerId, playerInventory,new ItemStack(ZiORiderItems.BEYONDRIVER.get()));
	}
	...
	public MiridewatchHolderGuiMenu(int containerId, Inventory playerInventory, ItemStack itemstack) {
