...
public class RiderGashatCaseGuiMenu extends AbstractContainerMenu {
    ...
    public RiderGashatCaseGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(ExAidRiderItems.RIDER_GASHAT_CASE.get()));
    }

    public RiderGashatCaseGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public RiderGashatCaseGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
