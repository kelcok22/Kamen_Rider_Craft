...
public class RidewatchHolderGuiMenu extends AbstractContainerMenu {
    ...
    public RidewatchHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(ZiORiderItems.ZIKU_DRIVER_ZI_O.get()));
    }

    public RidewatchHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public RidewatchHolderGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
