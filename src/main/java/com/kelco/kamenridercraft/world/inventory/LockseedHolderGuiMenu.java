...
public class LockseedHolderGuiMenu extends AbstractContainerMenu {
    private final Container container;

    public LockseedHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(GaimRiderItems.SENGOKU_DRIVER_GAIM.get()));
    }

    public LockseedHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public LockseedHolderGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
        super(ModMenus.LOCKSEED_HOLDER_GUI.get(), containerId);
