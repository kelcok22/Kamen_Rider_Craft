...
public class RingHolderGuiMenuBeast extends AbstractContainerMenu {
    ...
    public RingHolderGuiMenuBeast(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(WizardRiderItems.BEAST_DRIVER.get()));
    }

    public RingHolderGuiMenuBeast(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public RingHolderGuiMenuBeast(int containerId, Inventory inventory, ItemStack itemStack) {
