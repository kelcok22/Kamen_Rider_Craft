...
public class ChemyRiserGuiMenu extends AbstractContainerMenu {
    ...
    public ChemyRiserGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(GotchardRiderItems.CHEMY_RISER.get()));
    }

    public ChemyRiserGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public ChemyRiserGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
        ...
        this.addSlot(new Slot(container, 0, 116, 35) {
            ...
            public boolean mayPlace(ItemStack itemStack) {
                return (itemStack.getItem() == GotchardRiderItems.BLANK_RIDE_CHEMY_CARD.get() | itemStack.getItem() == GotchardRiderItems.UFO_X_RIDE_CHEMY_CARD.get() | itemStack.getItem() == GotchardRiderItems.TAMAGON_RIDE_CHEMY_CARD.get());
            }
        });
            ...
            for (int k1 = 0; k1 < 9; ++k1) {
                this.addSlot(new Slot(inventory, k1 + i1 * 9 + 9, 8 + k1 * 18, 84 + i1 * 18) {
                    ...
                    public boolean mayPickup(@NotNull Player player) {
                        return !(this.getItem().getItem() instanceof ChemyRiserItem);
                    }
                });
            }
        }
