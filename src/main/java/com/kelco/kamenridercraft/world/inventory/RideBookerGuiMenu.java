...
public class RideBookerGuiMenu extends AbstractContainerMenu {
    ...
    public RideBookerGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(DecadeRiderItems.RIDE_BOOKER.get()));
    }

    public RideBookerGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public RideBookerGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
