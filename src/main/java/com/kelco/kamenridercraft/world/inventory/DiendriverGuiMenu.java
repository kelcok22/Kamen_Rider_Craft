...
public class DiendriverGuiMenu extends AbstractContainerMenu {
    ...
    public DiendriverGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(DecadeRiderItems.DIENDRIVER.get()));
    }

    public DiendriverGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public DiendriverGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
