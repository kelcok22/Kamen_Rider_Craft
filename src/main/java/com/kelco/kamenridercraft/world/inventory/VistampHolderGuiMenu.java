...
public class VistampHolderGuiMenu extends AbstractContainerMenu {
    ...
    public VistampHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(ReviceRiderItems.REVICE_DRIVER.get()));
    }

    public VistampHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public VistampHolderGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
