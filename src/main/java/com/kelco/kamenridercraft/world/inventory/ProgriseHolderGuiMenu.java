...
public class ProgriseHolderGuiMenu extends AbstractContainerMenu {
    ...
    public ProgriseHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(ZeroOneRiderItems.PROGRISE_HOLDER.get()));
    }

    public ProgriseHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public ProgriseHolderGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
