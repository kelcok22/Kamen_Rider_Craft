...
public class GotchancollectionPanelGuiMenu extends AbstractContainerMenu {
    private final Container container;

    public GotchancollectionPanelGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(GotchardRiderItems.GOTCHANCOLLECTION_PANEL.get()));
    }

    public GotchancollectionPanelGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public GotchancollectionPanelGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
