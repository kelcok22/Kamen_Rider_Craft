...
public class EnergyItemHolderGuiMenu extends AbstractContainerMenu {
    ...
    public EnergyItemHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf) {
        this(containerId, inventory, new ItemStack(ExAidRiderItems.ENERGY_ITEM_HOLDER.get()));
    }

    public EnergyItemHolderGuiMenu(int containerId, Inventory inventory, FriendlyByteBuf friendlyByteBuf, ItemStack itemStack) {
        this(containerId, inventory, itemStack);
    }

    public EnergyItemHolderGuiMenu(int containerId, Inventory inventory, ItemStack itemStack) {
