...
public class OblivionGoreNightmareEntity extends BaseHenchmenEntity {
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(OblivionGoreNightmareEntity.class, EntityDataSerializers.BYTE);
