...
public class LordBaronEntity extends BaseHenchmenEntity {
    ...
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(LordBaronEntity.class, EntityDataSerializers.BYTE);


    public LordBaronEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="lord_baron";
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(GaimRiderItems.GURONBARYAMU.get()));
    }
