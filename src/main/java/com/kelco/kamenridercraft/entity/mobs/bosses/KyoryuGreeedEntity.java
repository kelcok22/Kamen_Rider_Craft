...
public class KyoryuGreeedEntity extends BaseHenchmenEntity {



    public KyoryuGreeedEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="kyoryu_complete_ptera";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(OOORiderItems.GREEED_BLET_KYORYU.get()));
