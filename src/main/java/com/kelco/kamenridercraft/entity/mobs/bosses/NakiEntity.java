...
public class NakiEntity extends BaseHenchmenEntity {
    ...
    public NakiEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="naki";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ZeroOneRiderItems.FORCERISER_NAKI.get()));
    }
