...
public class GlottaEntity extends BaseHenchmenEntity {



    public GlottaEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="glotta_stomach";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(GavvRiderItems.GLOTTA_MIMICDEVISER.get()));
       this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(GavvRiderItems.GLOTTA_SCYTHE.get()));
    }
