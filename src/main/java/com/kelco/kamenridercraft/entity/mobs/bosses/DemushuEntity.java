...
public class DemushuEntity extends BaseHenchmenEntity {
    ...
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(DemushuEntity.class, EntityDataSerializers.BYTE);
    ...
    public DemushuEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="demushu";
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(GaimRiderItems.SHEIMU.get()));
    }
