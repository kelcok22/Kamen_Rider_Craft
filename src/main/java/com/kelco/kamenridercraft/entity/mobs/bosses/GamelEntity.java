...
public class GamelEntity extends BaseHenchmenEntity {
    ...
    public GamelEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="gamel";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(OOORiderItems.GREEED_BLET_GAMEL.get()));
    }
