...
public class ZamonasEntity extends BaseHenchmenEntity {
    public ZamonasEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="zamonas";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Zi_O_Rider_Items.ZIKU_DRIVER_ZAMONAS.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(Zi_O_Rider_Items.ZAMONAS_BOW.get()));
    }
