...
public class ZamonasEntity extends BaseHenchmenEntity {
    public ZamonasEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ZiORiderItems.ZIKU_DRIVER_ZAMONAS.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ZiORiderItems.ZAMONAS_BOW.get()));
    }
