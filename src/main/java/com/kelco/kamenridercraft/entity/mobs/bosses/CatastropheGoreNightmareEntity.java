...
public class CatastropheGoreNightmareEntity extends BaseHenchmenEntity {
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(CatastropheGoreNightmareEntity.class, EntityDataSerializers.BYTE);
