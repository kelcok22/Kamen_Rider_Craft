...
public class ZaiaEntity extends BaseHenchmenEntity {
    ...
    public ZaiaEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="zaia";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(ZeroOneRiderItems.ZAIA_THOUSANDRIVER_ZAIA.get()));
        this.setItemSlot(EquipmentSlot.MAINHAND, new ItemStack(ZeroOneRiderItems.THOUSAND_JACKER.get()));
    }
