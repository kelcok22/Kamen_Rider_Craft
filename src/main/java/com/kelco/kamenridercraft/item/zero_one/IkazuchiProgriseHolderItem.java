...
public class IkazuchiProgriseHolderItem extends Item {
    private static final Component UNKNOWN_CONTENTS = Component.translatable("container.shulkerBox.unknownContents");

    public IkazuchiProgriseHolderItem() {
        super(new Properties().stacksTo(1).rarity(Rarity.COMMON).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    }

    public IkazuchiProgriseHolderItem AddToTabList(List<Item> TabList) {
        TabList.add(this);
        return this;
    }
        ...
        if (!world.isClientSide && entity instanceof ServerPlayer serverPlayer) {
            serverPlayer.openMenu(new MenuProvider() {
                ...
                public Component getDisplayName() {
                    return Component.literal("Ikazuchi's Progrise Holder");
                }
                ...
                public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                    ...
                    return new IkazuchiProgriseHolderGuiMenu(id, inventory, packetBuffer,itemstack);
                }
            }, buf -> {
