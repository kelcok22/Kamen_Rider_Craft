...
public class Faiz_Rider_Items {
	...
	public static final DeferredItem<Item> FAIZ_BLASTER_MISSION_MEMORY = ITEMS.register("faiz_blaster_mission_memory",
			...
			}.addSwitchForm(FAIZ_BLASTER_BLOODY_CANNONS.get()).ChangeBeltModel("geo/faiz_belt.geo.json").IsBeltGlowing().IsGlowing().AddToList(RiderTabs.FAIZ_TAB_ITEM));
	...
	public static final DeferredItem<Item> FAIZ_GOLD_BLASTER_MISSION_MEMORY = ITEMS.register("faiz_gold_blaster_mission_memory",
			...
			}.addSwitchForm(FAIZ_GOLD_BLASTER_BLOODY_CANNONS.get()).ChangeModel("faiz_blaster.geo.json").ChangeBeltModel("geo/faiz_belt.geo.json").IsGlowing().AddToList(RiderTabs.FAIZ_TAB_ITEM));
	...
	public static final DeferredItem<Item> PSYGA_MISSION_MEMORY = ITEMS.register("psyga_mission_memory",
			...
			}.ChangeBeltModel("geo/psyga_belt.geo.json").IsBeltGlowing().IsGlowing().AddToList(RiderTabs.FAIZ_TAB_ITEM));
    ...
    public static final DeferredItem<Item> FLYING_ATTACKER = ITEMS.register("flying_attacker",
            ...
            }.addAlternative(FLYING_ATTACKER_RIOTROOPER.get()).ChangeBeltModel("geo/psyga_belt.geo.json").IsBeltGlowing().IsGlowing().AddToList(RiderTabs.FAIZ_TAB_ITEM));
	...
	public static final DeferredItem<Item> ORGA_MISSION_MEMORY = ITEMS.register("orga_mission_memory",
			...
			}.ChangeBeltModel("geo/orga_belt.geo.json").IsGlowing().AddToList(RiderTabs.FAIZ_TAB_ITEM));
	...
	public static final DeferredItem<Item> FAIZ_DRIVER_NEXT = ITEMS.register("faiz_driver_next",
			() -> new FaizDriverNextItem(ArmorMaterials.DIAMOND,"next_faiz",NEXT_FAIZ_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON)).AddToTabList(RiderTabs.FAIZ_TAB_ITEM).ChangeRepairItem(BLANK_MISSION_MEMORY.get()));

	public static final DeferredItem<Item> NEXT_KAIXA_DRIVER = ITEMS.register("next_kaixa_driver",
			() -> new NextKaixaDriverItem(ArmorMaterials.DIAMOND,"next_kaixa",NEXT_KAIXA_MISSION_MEMORY ,FAIZHELMET, FAIZCHESTPLATE, FAIZLEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON)).AddToTabList(RiderTabs.FAIZ_TAB_ITEM).ChangeRepairItem(BLANK_MISSION_MEMORY.get()));
