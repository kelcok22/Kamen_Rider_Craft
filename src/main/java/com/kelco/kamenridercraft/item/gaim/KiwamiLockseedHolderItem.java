...
public class KiwamiLockseedHolderItem extends Item {
    private static final Component UNKNOWN_CONTENTS = Component.translatable("container.shulkerBox.unknownContents");

    public KiwamiLockseedHolderItem() {
        super(new Properties().stacksTo(1).rarity(Rarity.COMMON).component(DataComponents.CONTAINER, ItemContainerContents.EMPTY));
    }

    public KiwamiLockseedHolderItem AddToTabList(List<Item> TabList) {
        TabList.add(this);
        return this;
    }
        ...
        if (!world.isClientSide && entity instanceof ServerPlayer serverPlayer) {
            serverPlayer.openMenu(new MenuProvider() {
                ...
                public Component getDisplayName() {
                    return Component.literal("Kiwami Lockseed Holder");
                }
                ...
                public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                    ...
                    return new KiwamiLockseedHolderGuiMenu(id, inventory, packetBuffer,itemstack);
                }
            }, buf -> {
