...
public class ExAidRiderItems {
    ...
    public static final DeferredItem<Item> PROTO_MIGHTY_ACTION_X_GASHAT_LV_1 = ITEMS.register("proto_mighty_action_x_gashat_lv_1",
            () -> new RiderFormChangeItem(new Item.Properties(),"_lv1","genm","gamer_driver_proto_mighty_action_x_lv_1",
                ...
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    ...
                    .isGlowing().changeModel("lv_1.geo.json").changeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()));
    ...
    public static final DeferredItem<Item> MIGHTY_BROTHERS_XX_GASHAT = ITEMS.register("mighty_brothers_xx_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lvx","ex_aid","gamer_driver_mighty_brothers_x",
                ...
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    ...
                    .isGlowing().changeModel("lv_1.geo.json").changeBeltModel("geo/lv_1_belt.geo.json").addShiftForm(MIGHTY_BROTHERS_XX_GASHAT_R.get()).alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).addToList(GameCreator.BLANK_DOUBLE_GASHAT, 20));
    ...
    public static final DeferredItem<Item> MAXIMUM_MIGHTY_X_GASHAT = ITEMS.register("maximum_mighty_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lv99","ex_aid","gamer_driver_maximum_mighty_x",
                ...
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    ...
                    .isGlowing().changeModel("lv_max.geo.json").changeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).addToList(GameCreator.BLANK_MAXIMUM_GASHAT, 20));
    ...
    public static final DeferredItem<Item> GOD_MAXIMUM_MIGHTY_X_GASHAT = ITEMS.register("god_maximum_mighty_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lv_billion","genm","gamer_driver_god_maximum_mighty_x",
                ...
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    ...
                    .changeModel("lv_max.geo.json").changeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).addToList(GameCreator.BLANK_MAXIMUM_GASHAT, 5));
    ...
    public static final DeferredItem<Item> HYPER_MUTEKI_GASHAT = ITEMS.register("hyper_muteki_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"_muteki","ex_aid","gamer_driver_hyper_muteki",
                ...
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    ...
                    .isGlowing().addNeedForm(MAXIMUM_MIGHTY_X_GASHAT.get(), 1).alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).addToList(DecadeRiderItems.COMPLETE_21_FORMS).addToList(GameCreator.BLANK_HYPER_GASHAT, 20));
    ...
    public static final DeferredItem<Item> KAIGEN_GHOST_GASHAT_LV_1 = ITEMS.register("kaigan_ghost_gashat_lv_1",
            ...
            }.changeModel("lv_1.geo.json").changeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(ModdedItemCore.BLANK_FORM.get()));
