package com.kelco.kamenridercraft.item.heisei_phase_2.wizard;
            ...
            if (ArrayUtils.contains(FORMS, belt.riderName)) {
                ...
                if (copy != null) {
                    ...
                    if (summonBelt == KabutoRiderItems.KABUTO_RIDER_BELT.get())
                        RiderDriverItem.setFormItem(copy.getItemBySlot(EquipmentSlot.FEET), KabutoRiderItems.KABUTO_ZECTER.get(), 1);
