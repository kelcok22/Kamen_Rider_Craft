...
public class Ghost_Rider_Items {
	...
	public static final DeferredItem<Item> ORE_GHOST_EYECON = ITEMS.register("ore_ghost_eyecon",
			...
			}.addAlternative(ORE_DAMASHII.get()).alsoChange2ndSlot(ORE_DAMASHII.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM));
	...
	public static final DeferredItem<Item> BOOST_GHOST_EYECON = ITEMS.register("boost_ghost_eyecon",
			...
			}.addAlternative(BOOST_DAMASHII.get()).alsoChange2ndSlot(BOOST_DAMASHII.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM));
	...
	public static final DeferredItem<Item> DARK_NECROM_RED_GHOST_EYECON = ITEMS.register("dark_necrom_red_ghost_eyecon",
			...
			}.AddNum(0).ChangeModel("damashii.geo.json").ChangeSlot(2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM));
	...
	public static final DeferredItem<Item> TUTANKHAMUN_GHOST_EYECON = ITEMS.register("tutankhamun_ghost_eyecon",
			...
			}.AddNum(2).ChangeModel("damashii.geo.json").ChangeSlot(2).AddToList(Monolith.GHOST_EYECONS,3).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM));
	...
	public static final DeferredItem<Item> HOUDINI_GHOST_EYECON = ITEMS.register("houdini_ghost_eyecon",
			...
			}.AddNum(2).ChangeModel("damashii.geo.json").ChangeSlot(2).AddToList(Monolith.GHOST_EYECONS,2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM));
	...
	public static final DeferredItem<Item> GHOST_DRIVER = ITEMS.register("ghost_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"ghost",ORE_GHOST_EYECON ,1, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(ORE_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> SPECTER_DRIVER = ITEMS.register("specter_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"specter",SPECTER_GHOST_EYECON ,2, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(SPECTER_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> MEGA_ULORDER = ITEMS.register("mega_ulorder",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"necrom",NECROM_GHOST_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(NECROM_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> DARK_GHOST_DRIVER = ITEMS.register("dark_ghost_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_ghost",DARK_GHOST_EYECON ,1, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(DARK_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> EXTREMER_DRIVER = ITEMS.register("extremer_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"extremer",UNFINISHED_EXTREMER_DRIVER , GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON))
					.Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> ZERO_SPECTER_DRIVER = ITEMS.register("zero_specter_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"zero_specter",ZERO_SPECTER_GHOST_EYECON ,2, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(ZERO_SPECTER_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> KANON_SPECTER_DRIVER = ITEMS.register("kanon_specter_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"kanon_specter",KANON_SPECTER_GHOST_EYECON ,2, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(KANON_SPECTER_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> PROTO_MEGA_ULORDER_RED = ITEMS.register("proto_mega_ulorder_red",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_necrom",NECROM_GHOST_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(DARK_NECROM_RED_GHOST_EYECON).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));

	public static final DeferredItem<Item> PROTO_MEGA_ULORDER_BLUE = ITEMS.register("proto_mega_ulorder_blue",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_necrom",NECROM_GHOST_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(DARK_NECROM_BLUE_GHOST_EYECON).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));

	public static final DeferredItem<Item> PROTO_MEGA_ULORDER_YELLOW = ITEMS.register("proto_mega_ulorder_yellow",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_necrom",NECROM_GHOST_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(DARK_NECROM_YELLOW_GHOST_EYECON).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));

	public static final DeferredItem<Item> PROTO_MEGA_ULORDER_PINK = ITEMS.register("proto_mega_ulorder_pink",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_necrom",NECROM_GHOST_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(DARK_NECROM_PINK_GHOST_EYECON).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));

	public static final DeferredItem<Item> NEW_GHOST_DRIVER = ITEMS.register("new_ghost_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"dark_ghost",DARK_GHOST_EYECON ,1, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(NEW_ORE_GHOST_EYECON).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> ZERO_GHOST_DRIVER = ITEMS.register("zero_ghost_driver",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"zero_ghost",PROTO_ORE_GHOST_EYECON ,1, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(PROTO_ORE_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> PROTO_MEGA_ULORDER_IGOR = ITEMS.register("proto_mega_ulorder_gamma_superior",
			() -> new GhostDriverItem(ArmorMaterials.DIAMOND,"gamma_superior",TRANSFORM_GAMMA_EYECON ,0, GHOST_HELMET,GHOST_CHESTPLATE,GHOST_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(GAMMA_SUPERIOR_DAMASHII).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).ChangeRepairItem(BLANK_GHOST_EYECON.get()));


	public static final DeferredItem<Item> GAN_GUN_SABER_BLADE = ITEMS.register("gan_gun_saber_blade",
			() -> new BaseSwordItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS).AddToList(Decade_Rider_Items.COMPLETE_21_WEAPONS).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
	...
	public static final DeferredItem<Item> GAN_GUN_HAND_ROD = ITEMS.register("gan_gun_hand_rod",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 6, -2.4F, new Item.Properties()).IsSwordGun().AddToList(KamenRiderCraftCore.CreativeTabRegistry.GHOST_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS).ChangeRepairItem(BLANK_GHOST_EYECON.get()));
