...
public class W_Rider_Items {
	...
	public static final DeferredItem<Item> JOKER_JOKER_MEMORY = ITEMS.register("joker_joker_memory",
			...
			}.allowRiderKick().IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM));
	...
	public static final DeferredItem<Item> JOKER_MEMORY = ITEMS.register("joker_memory",
			...
			}.allowRiderKick().IsGlowing().ChangeSlot(2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(GaiaMemoryRefinerBlock.GAIA_MEMORY_G, 20));
	...
	public static final DeferredItem<Item> XTREME_MEMORY = ITEMS.register("xtreme_memory",
			...
			}.IsGlowing().alsoChange2ndSlot(JOKER_MEMORY.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_FORMS));
	...
	public static final DeferredItem<Item> SKULL_MEMORY = ITEMS.register("skull_memory",
			...
			}.addSwitchForm(SKULL_MEMORY_CRYSTAL.get()).addAlternative(CYCLONE_SKULL_MEMORY.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(GaiaMemoryRefinerBlock.GAIA_MEMORY_S, 5));
	...
	public static final DeferredItem<Item> ETERNAL_MEMORY = ITEMS.register("eternal_memory",
			...
			}.IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(GaiaMemoryRefinerBlock.GAIA_MEMORY_S, 1));
	...
	public static final DeferredItem<Item> CYCLONE_T2_MEMORY = ITEMS.register("cyclone_t2_memory",
			...
			}.IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(GaiaMemoryRefinerBlock.GAIA_MEMORY_T2, 1));
	...
	public static final DeferredItem<Item> JOKER_T2_MEMORY = ITEMS.register("joker_t2_memory",
			...
			}.allowRiderKick().IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(GaiaMemoryRefinerBlock.GAIA_MEMORY_T2, 5));
	...
	public static final DeferredItem<Item> MEMORY_MEMORY = ITEMS.register("memory_memory",
			...
			}.ChangeSlot(4).addSwitchForm(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM));
	...
	public static final DeferredItem<Item> WDRIVER = ITEMS.register("wdriver",
			() -> new WDriverItem(ArmorMaterials.DIAMOND,"w",CYCLONE_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(JOKER_MEMORY).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).ChangeRepairItem(GAIA_MEMORY.get()).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS));
	...
	public static final DeferredItem<Item> ACCELDRIVER = ITEMS.register("acceldriver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"accel",ACCEL_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties())
					.AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));
	...
	public static final DeferredItem<Item> LOSTDRIVER_SKULL = ITEMS.register("lostdriver_skull",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"skull",SKULL_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));
	...
	public static final DeferredItem<Item> GAIA_DRIVER_TERROR = ITEMS.register("gaia_driver_terror",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"terror_dopant",TERROR_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));

	public static final DeferredItem<Item> GAIA_DRIVER_TABOO = ITEMS.register("gaia_driver_taboo",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"taboo_dopant",TABOO_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));

	public static final DeferredItem<Item> GAIA_DRIVER_CLAYDOLL = ITEMS.register("gaia_driver_claydoll",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"claydoll_dopant",CLAYDOLL_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));

	public static final DeferredItem<Item> GAIA_DRIVER_SMILODON = ITEMS.register("gaia_driver_smilodon",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"smilodon_dopant",SMILODON_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));

	public static final DeferredItem<Item> GAIA_DRIVER_NASCA = ITEMS.register("gaia_driver_nasca",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"nazca_dopant",NASCA_MEMORY ,WHELMET,WCHESTPLATE,WLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM)
					.ChangeRepairItem(GAIA_MEMORY.get()).ChangeRepairItem( GAIA_MEMORY.get()));
	...
	public static final DeferredItem<Item> PRISM_BICKER = ITEMS.register("prism_bicker",
			() -> new BaseSwordItem(Tiers.DIAMOND, 9, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON)).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_WEAPONS).ChangeRepairItem( GAIA_MEMORY.get()));


	public static final DeferredItem<Item> SHIELD_PRISM_BICKER = ITEMS.register("shield_prism_bicker",
			() -> new BaseShieldItem(new Item.Properties().rarity(Rarity.UNCOMMON)).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToTabList(Decade_Rider_Items.COMPLETE_21_WEAPONS).ChangeRepairItem( GAIA_MEMORY.get()));
	...
	public static final DeferredItem<Item> SKILL_MAGNUM = ITEMS.register("skull_magnum",
			() -> new BaseBlasterItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS).ChangeRepairItem( GAIA_MEMORY.get()));

	public static final DeferredItem<Item> ENGINE_BLADE = ITEMS.register("engine_blade",
			() -> new BaseSwordItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.W_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS).ChangeRepairItem( GAIA_MEMORY.get()));
