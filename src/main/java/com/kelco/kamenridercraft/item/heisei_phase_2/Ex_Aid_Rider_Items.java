...
public class Ex_Aid_Rider_Items {
    ...
    public static final DeferredItem<Item> MIGHTY_ACTION_X_GASHAT = ITEMS.register("mighty_action_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","ex_aid","gamer_driver_mighty_action_x",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_FORMS).AddToList(GameCreator.BLANK_GASHAT, 20));
    ...
    public static final DeferredItem<Item> TADDLE_QUEST_X_GASHAT = ITEMS.register("taddle_quest_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","brave","gamer_driver_taddle_quest",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false),
                    new MobEffectInstance(EffectCore.SLASH, 40, 0,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
                    ...
                    .IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_FORMS).AddToList(GameCreator.BLANK_GASHAT, 15));
    ...
    public static final DeferredItem<Item> BANG_BANG_SHOOTING_GASHAT = ITEMS.register("bang_bang_shooting_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","snipe","gamer_driver_bang_bang_shooting",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false),
                    new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
    ...
    public static final DeferredItem<Item> BAKUSOU_BIKE_GASHAT_UNDER = ITEMS.register("bakusou_bike_gashat_under",
            () -> new RiderFormChangeItem(new Item.Properties(),"","lazer","gamer_driver_bakusou_bike",
    ...
    public static final DeferredItem<Item> BAKUSOU_BIKE_GASHAT_TURBO = ITEMS.register("bakusou_bike_gashat_turbo",
            () -> new RiderFormChangeItem(new Item.Properties(),"_turbo","lazer","gamer_driver_bakusou_bike",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> GEKITOTSU_ROBOTS_GASHAT = ITEMS.register("gekitotsu_robots_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"robot_gamer","ex_aid","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
    ...
    public static final DeferredItem<Item> GIRI_GIRI_CHAMBARA_GASHAT = ITEMS.register("giri_giri_chambara_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"chambara_gamer","lazer","gamer_driver_bakusou_bike",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .alsoChange1stSlot(BAKUSOU_BIKE_GASHAT_UNDER.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_GASHAT, 10));
    ...
    public static final DeferredItem<Item> DRAGO_KNIGHT_HUNTER_Z_GASHAT_BLADE = ITEMS.register("drago_knight_hunter_z_gashat_blade",
            () -> new RiderFormChangeItem(new Item.Properties(),"hunter_gamer_blade","brave","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 2,true,false),
    ...
    public static final DeferredItem<Item> DRAGO_KNIGHT_HUNTER_Z_GASHAT_FANG = ITEMS.register("drago_knight_hunter_z_gashat_fang",
            () -> new RiderFormChangeItem(new Item.Properties(),"hunter_gamer_fang","ex_aid","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
    ...
    public static final DeferredItem<Item> DRAGO_KNIGHT_HUNTER_Z_GASHAT = ITEMS.register("drago_knight_hunter_z_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"hunter_gamer","ex_aid","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
            ...
            }.SetFormToArmor().addShiftForm(DRAGO_KNIGHT_HUNTER_Z_GASHAT_FANG.get()).ChangeSlot(2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> PROTO_MIGHTY_ACTION_X_GASHAT = ITEMS.register("proto_mighty_action_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","genm","gamer_driver_proto_mighty_action_x",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 0,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().addSwitchForm(PROTO_MIGHTY_ACTION_X_GASHAT_LV_1.get()).alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> PROTO_TADDLE_QUEST_X_GASHAT = ITEMS.register("proto_taddle_quest_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"_proto_brave","brave","gamer_driver_proto_taddle_quest",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().addSwitchForm(PROTO_TADDLE_QUEST_GASHAT_LV_1.get()).alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> PROTO_BAKUSOU_BIKE_GASHAT_LV_1 = ITEMS.register("proto_bakusou_bike_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"_proto_lazer_lv1","lazer","gamer_driver_proto_bakusou_bike_lv_1",
                    new MobEffectInstance(MobEffects.JUMP, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 0,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));


    public static final DeferredItem<Item> PROTO_GEKITOTSU_ROBOTS_GASHAT = ITEMS.register("proto_gekitotsu_robots_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_robot_gamer","ex_aid","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 1,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
                    ((ServerLevel) player.level()).sendParticles(ModParticles.BLACK_SPARK_PARTICLES.get(),
                            player.getX(), player.getY()+1,
    ...
    public static final DeferredItem<Item> PROTO_JET_COMBAT_GASHAT_LAZER = ITEMS.register("proto_jet_combat_gashat_lazer",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_combat_gamer","lazer","gamer_driver_mighty_action_x",
                    new MobEffectInstance(EffectCore.BOOST, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 1,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
    ...
    public static final DeferredItem<Item> PROTO_JET_COMBAT_GASHAT = ITEMS.register("proto_jet_combat_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_combat_gamer","ex_aid","gamer_driver_mighty_action_x",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .addAlternative(PROTO_JET_COMBAT_GASHAT_LAZER.get()).SetFormToArmor().ChangeSlot(2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> PROTO_SHAKARIKI_SPORTS_GASHAT_LAZER = ITEMS.register("proto_shakariki_sports_gashat_lazer",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_sports_gamer","lazer","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 1,true,false)){
    ...
    public static final DeferredItem<Item> PROTO_SHAKARIKI_SPORTS_GASHAT = ITEMS.register("proto_shakariki_sports_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_sports_gamer","ex_aid","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 1,true,false)){
    ...
    public static final DeferredItem<Item> PROTO_DRAGO_KNIGHT_HUNTER_Z_GASHAT_CLAW = ITEMS.register("proto_drago_knight_hunter_z_gashat_claw",
            () -> new RiderFormChangeItem(new Item.Properties(),"proto_hunter_gamer_claw","lazer","gamer_driver_mighty_action_x",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 3,true,false),
    ...
    public static final DeferredItem<Item> DANGEROUS_ZOBIE_LAZER = ITEMS.register("dangerous_zombie_gashat_lazer",
            () -> new RiderFormChangeItem(new Item.Properties(),"chambara_gamer","lazer","gamer_driver_bakusou_bike",
                    ...
                    new MobEffectInstance(EffectCore.FORM_LOCK, 40, 0,true,false),
                    new MobEffectInstance(EffectCore.BUGSTER, 40, 10,true,false)){
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    super.OnTransformation(itemstack, player);
                    ((ServerLevel) player.level()).sendParticles(ModParticles.BLACK_SPARK_PARTICLES.get(),
                            player.getX(), player.getY()+1,
    ...
    public static final DeferredItem<Item> KAMEN_RIDER_CHRONICLE_GASHAT= ITEMS.register("kamen_rider_chronicle_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"_cronus","snipe","gamer_driver_chronicle",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 4,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 3,true,false),
    ...
    public static final DeferredItem<Item> TOKI_MEKI_CRISIS_GASHAT= ITEMS.register("toki_meki_crisis_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","poppy","gashacon_bugvisor_ii_poppy",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().addSwitchForm(TOKI_MEKI_CRISIS_GASHAT_RED_EYES.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> TADDLE_LEGACY_GASHAT = ITEMS.register("taddle_legacy_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"legacy_gamer","brave","gamer_driver_taddle_legacy",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .SetFormToArmor().ChangeSlot(2).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_GASHAT, 2));
    ...
    public static final DeferredItem<Item>  MIGHTY_BROTHERS_XX_GASHAT_L = ITEMS.register("mighty_brothers_xx_gashat_l",
            () -> new RiderFormChangeItem(new Item.Properties(),"_lvxxl","ex_aid","gamer_driver_mighty_brothers_xx",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 3,true,false)){
    ...
    public static final DeferredItem<Item> MIGHTY_BROTHERS_XX_GASHAT = ITEMS.register("mighty_brothers_xx_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lvx","ex_aid","gamer_driver_mighty_brothers_x",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().ChangeModel("lv_1.geo.json").ChangeBeltModel("geo/lv_1_belt.geo.json").addShiftForm(MIGHTY_BROTHERS_XX_GASHAT_R.get()).alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_DOUBLE_GASHAT, 20));
    ...
    public static final DeferredItem<Item> KNOCK_OUT_FIGHTER_2_GASHAT = ITEMS.register("knock_out_fighter_2_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lv39","ex_aid","gamer_driver_knock_out_fighter_2",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_DOUBLE_GASHAT, 5));
    ...
    public static final DeferredItem<Item> PERFECT_PUZZLE_GASHAT = ITEMS.register("perfect_puzzle_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"","para_dx","paradoxbelt",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().addAlternative(GASHAT_GEAR_DUAL.get()).alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_DOUBLE_GASHAT, 10));
    ...
    public static final DeferredItem<Item> MAXIMUM_MIGHTY_X_GASHAT = ITEMS.register("maximum_mighty_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lv99","ex_aid","gamer_driver_maximum_mighty_x",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().ChangeModel("lv_max.geo.json").ChangeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_MAXIMUM_GASHAT, 20));


    public static final DeferredItem<Item> GOD_MAXIMUM_MIGHTY_X_GASHAT_lv0 = ITEMS.register("god_maximum_mighty_x_gashat_lv0",
            () -> new RiderFormChangeItem(new Item.Properties(),"_lv0","genm","gamer_driver_god_maximum_mighty_x_lv0",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 4,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4,true,false),
    ...
    public static final DeferredItem<Item> GOD_MAXIMUM_MIGHTY_X_GASHAT = ITEMS.register("god_maximum_mighty_x_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON),"_lv_billion","genm","gamer_driver_god_maximum_mighty_x",
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4,true,false),
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .ChangeModel("lv_max.geo.json").ChangeBeltModel("geo/lv_1_belt.geo.json").alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(GameCreator.BLANK_MAXIMUM_GASHAT, 5));
    ...
    public static final DeferredItem<Item> HYPER_MUTEKI_GASHAT = ITEMS.register("hyper_muteki_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"_muteki","ex_aid","gamer_driver_hyper_muteki",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .IsGlowing().addNeedForm(MAXIMUM_MIGHTY_X_GASHAT.get(), 1).alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_FORMS).AddToList(GameCreator.BLANK_HYPER_GASHAT, 20));
    ...
    public static final DeferredItem<Item> HYPER_FUMESTU_GASHAT = ITEMS.register("hyper_fumetsu_gashat",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"_hyper_fumetsu","genm","gamer_driver_hyper_fumetsu",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 3,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 4,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 6,true,false),
    ...
    public static final DeferredItem<Item> THE_UNBEATABLE_GAME= ITEMS.register("the_unbeatable_game",
            () -> new RiderFormChangeItem(new Item.Properties(),"_totema","genm_bugvisor","gamer_driver_dangerous_zombie",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
    ...
    public static final DeferredItem<Item> BERCODE_WARRIOR_DECADE_GASHAT = ITEMS.register("barcode_warrior_decade_gashat",
            () -> new RiderFormChangeItem(new Item.Properties(),"_decade","ex_aid","gamer_driver_barcode_warrior_decade",
                ...
                public void OnTransformation(ItemStack itemstack, LivingEntity player) {
                    ...
                    .alsoChange2ndSlot(Modded_item_core.BLANK_FORM.get()).AddToList(GanbarizingMachine.BLANK_GASHAT, 1).AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM));
    ...
    public static final DeferredItem<Item> GAMER_DRIVER_EX_AID = ITEMS.register("gamer_driver_ex_aid",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"ex_aid",MIGHTY_ACTION_X_GASHAT_LV_1,MIGHTY_ACTION_X_GASHAT ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties())
                    .AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> GAMER_DRIVER_TRUE_BRAVE = ITEMS.register("gamer_driver_truebrave",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"truebrave",TADDLE_LEGACY_GASHAT_TRUE ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON))
                    .Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> GASHACON_BUGVISOR_GENM = ITEMS.register("gashacon_bugvisor_genmu",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"genm_bugvisor",DANGEROUS_ZOBIE_GASHAT_BD ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON))
                    .Override_belt_text("gashacon_bugvisor").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> GASHACON_BUGVISOR_II_CHRONOS = ITEMS.register("gashacon_bugvisor_ii_chronos",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"chronos",KAMEN_RIDER_CHRONICLE_GASHAT ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties().rarity(Rarity.UNCOMMON))
                    .Override_belt_text("gashacon_bugvisor_ii").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> GASHACON_BUGVISOR_II_LAZER = ITEMS.register("gashacon_bugvisor_ii_lazer",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"lazer_lvx_",GIRI_GIRI_CHAMBARA_GASHAT_X ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties())
                    .Dont_show_belt_form_info().Override_belt_text("gashacon_bugvisor_ii_lazer").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> GASHACON_BUGVISOR_II_CHRONICLE_BUGTER = ITEMS.register("gashacon_bugvisor_ii_chronicle_bugster",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"chronicle_bugster",KAMEN_RIDER_CHRONICLE_GASHAT ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties())
                    .Dont_show_belt_form_info().Override_belt_text("gashacon_bugvisor_ii_chronicle_bugster_belt").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> NINjA_PLAYER_BELT = ITEMS.register("ninjaplayerbelt",
            () -> new GamerDriverItem(ArmorMaterials.DIAMOND,"ninja_player",UNFINISHED_KAMEN_RIDER_CHRONICLE_GASHAT ,EX_AIDHELMET, EX_AIDCHESTPLATE,EX_AIDLEGGINGS , new Item.Properties())
                    .Dont_show_belt_form_info().Override_belt_text("ninja_player_belt").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).ChangeRepairItem(BLANK_GASHAT.get()));


    public static final DeferredItem<Item> GASHACON_BREAKER = ITEMS.register("gashacon_breaker",
            () -> new BaseSwordItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).IsChangeSword().AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS)
    ...
    public static final DeferredItem<Item> GASHACON_KEY_SLASHER = ITEMS.register("gashacon_key_slasher",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 11, -3F, new Item.Properties()).IsSwordGun().AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_WEAPONS)
                    .ChangeRepairItem(BLANK_GASHAT.get()));

    public static final DeferredItem<Item> GASHACON_SWORD = ITEMS.register("gashacon_sword",
            () -> new BaseSwordItem(Tiers.DIAMOND, 6, -2F, new Item.Properties()).IsChangeSword().AddToList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM).AddToList(Decade_Rider_Items.NEO_DIEND_SUMMON_WEAPONS)
                    .ChangeRepairItem(BLANK_GASHAT.get()));
    ...
    public static final DeferredItem<Item> DEUS_RAMPART = ITEMS.register("deus_rampart",
            () -> new BaseShieldItem(new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.EX_AID_TAB_ITEM)
                    .ChangeRepairItem(BLANK_GASHAT.get()));
