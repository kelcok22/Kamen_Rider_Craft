...
public class Fourze_Rider_Items {
	...
	public static final DeferredItem<Item> COSMIC_ASTROSWITCH = ITEMS.register("cosmic_switch",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"_cosmic_module","fourze","fourze_driver_belt",
					...
					.alsoChange5thSlot(FOURZE_COSMIC_STATES.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_FORMS).AddToList(AstroswitchProgrammer.ASTROSWITCH, 1));
	...
	public static final DeferredItem<Item> FOURZE_DRIVER = ITEMS.register("fourze_driver",
			() -> new FourzeDriverItem(ArmorMaterials.DIAMOND,"fourze",BLANK_CIRCLE_ASTROSWITCH ,FOURZE_HELMET,FOURZE_CHESTPLATE,FOURZE_LEGGINGS , new Item.Properties())
					.Add_Extra_Base_Form_Items(BLANK_CROSS_ASTROSWITCH,BLANK_TRIANGLE_ASTROSWITCH,BLANK_SQUARE_ASTROSWITCH,FOURZE_BASE_STATES).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(BLANK_ASTROSWITCH.get()));
	...
	public static final DeferredItem<Item> METEOR_DRIVER = ITEMS.register("meteor_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"meteor",METEOR_ASTROSWITCH ,FOURZE_HELMET,FOURZE_CHESTPLATE,FOURZE_LEGGINGS  ,
					new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).AddToTabList(Decade_Rider_Items.NEO_DIEND_SUMMON_BELTS).ChangeRepairItem(BLANK_ASTROSWITCH.get()));
	...
	public static final DeferredItem<Item> IKAROS_DRIVER = ITEMS.register("ikaros_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"ikaros",IKAROS_ASTROSWITCH ,FOURZE_HELMET,FOURZE_CHESTPLATE,FOURZE_LEGGINGS  ,
					new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).ChangeRepairItem(BLANK_ASTROSWITCH.get()));
	...
	public static final DeferredItem<Item> GINGA_OH_DRIVER = ITEMS.register("ginga_oh_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"super_gingaoh",SOLU_ASTROSWITCH ,FOURZE_HELMET,FOURZE_CHESTPLATE,FOURZE_LEGGINGS  ,
					new Item.Properties()).Dont_show_belt_form_info().Add_Extra_Base_Form_Items(OOO_Rider_Items.SAME_MEDAL,OOO_Rider_Items.KUJIRA_MEDAL,OOO_Rider_Items.OOKAMIUO_MEDAL).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).ChangeRepairItem(BLANK_ASTROSWITCH.get()));


	public static final DeferredItem<Item> ASTROSWITCH_CASE = ITEMS.register("astroswitch_case",
			() -> new AstroswitchCaseItem().has_basic_model().AddToList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM));
	...
	public static final DeferredItem<Item> BARIZUN_SWORD = ITEMS.register("barizun_sword",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON)).IsChangeSword().AddToList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM).AddToList(Decade_Rider_Items.COMPLETE_21_WEAPONS).ChangeRepairItem(BLANK_ASTROSWITCH.get()));

	public static final DeferredItem<Item> SHIELD_MODULE = ITEMS.register("shield_module",
			() -> new BaseShieldItem(new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.FOURZE_TAB_ITEM)
					.ChangeRepairItem(BLANK_ASTROSWITCH.get()));
