...
public class Ex_Aid_Rider_Items {
	...
	public static final DeferredItem<Item> SHRINK_ENERGY_ITEM = ITEMS.register("shrink_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.SMALL, 500, 2,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));

	//christmas_energy_item

	public static final DeferredItem<Item> STRETCH_ENERGY_ITEM = ITEMS.register("stretch_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.STRETCH, 500, 2,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
	...
	public static final DeferredItem<Item> REFLECT_ENERGY_ITEM = ITEMS.register("reflect_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.REFLECT, 500, 0,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));

	//reflect_energy_item
	public static final DeferredItem<Item> SAVE_ENERGY_ITEM = ITEMS.register("save_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.MUTEKI, 500, 0,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
	...
	public static final DeferredItem<Item> GIANT_ENERGY_ITEM = ITEMS.register("giant_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.BIG, 500, 2,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
	...
	public static final DeferredItem<Item> SLEEP_ENERGY_ITEM = ITEMS.register("sleep_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.SLEEP, 500, 0,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
	...
	public static final DeferredItem<Item> FLATTEN_ENERGY_ITEM = ITEMS.register("flatten_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.FLAT, 500, 2,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));

	public static final DeferredItem<Item> BALLOON_ENERGY_ITEM = ITEMS.register("balloon_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.WIDE, 500, 2,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
	...
	public static final DeferredItem<Item> END_ENERGY_ITEM = ITEMS.register("end_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.EXPLODE, 500, 1,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));

	//random_energy_item
	//bug_energy_item
	public static final DeferredItem<Item> BUG_ENERGY_ITEM = ITEMS.register("bug_energy_item",
			() -> new ExAidEnergyItem(new Item.Properties(),new MobEffectInstance(Effect_core.BUGSTER, 500, 1,true,false)).AddToTabList(RiderTabs.EX_AID_TAB_ITEM));
