...
public class Zeztz_Rider_Items {
    ...
    public static final DeferredItem<Item> PROJECTION_CAPSEM = ITEMS.register("projection_capsem",
            ...
            }.addAlternative(PROJECTION_CAPSEM_METAMATERIAM.get()).ChangeModel("zeztz.geo.json").ChangeBeltModel("geo/zeztz_riderbelt.geo.json").IsBeltGlowing().IsGlowing().has_basic_model().AddToList(CapsemDropper.CAPSEM,5).AddToList(RiderTabs.ZEZTZ_TAB_ITEM));
    ...
    public static final DeferredItem<Item> PLASMA_CAPSEM = ITEMS.register("plasma_capsem",
            () -> new RiderFormChangeItem(new Item.Properties(),"_inazuma_plasma","zeztz","zeztz_driver_belt_inazuma_plasma",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(Effect_core.THUNDER_PUNCH, 40, 0,true,false),
                    new MobEffectInstance(Effect_core.PUNCH, 40, 3,true,false)){
            ...
            }.addAlternative(PLASMA_CAPSEM_METAMATERIAM.get()).ChangeModel("zeztz.geo.json").ChangeBeltModel("geo/zeztz_riderbelt.geo.json").IsBeltGlowing().IsGlowing().has_basic_model().AddToList(RiderTabs.ZEZTZ_TAB_ITEM));

    public static final DeferredItem<Item> BOOSTER_CAPSEM = ITEMS.register("booster_capsem",
            () -> new RiderFormChangeItem(new Item.Properties(),"_plasma_booster","zeztz","zeztz_driver_belt_plasma_booster",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
    ...
    public static final DeferredItem<Item> DUALMARE_CAPSEM = ITEMS.register("dualmare_capsem",
            () -> new RiderFormChangeItem(new Item.Properties(),"_catastrom","zeztz","zeztz_driver_belt_catastrom",
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2,true,false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
                    new MobEffectInstance(MobEffects.NIGHT_VISION, 400, 0, true, false),
            ...
            }.addSwitchForm(DUALMARE_CAPSEM_ORDERM.get()).ChangeModel("zeztz.geo.json").ChangeBeltModel("geo/zeztz_riderbelt.geo.json").IsBeltGlowing().IsGlowing().has_basic_model().AddToList(RiderTabs.ZEZTZ_TAB_ITEM));
    ...
    public static final DeferredItem<Item> BREAKAM_ZEZTZER_GUN = ITEMS.register("breakam_zeztzer_gun",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToList(RiderTabs.ZEZTZ_TAB_ITEM)
                    .ChangeRepairItem(CODE_CAPSEM.get()));
    ...
    public static final DeferredItem<Item> INAZUMA_BLASTER = ITEMS.register("inazuma_blaster",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 6, -2F, new Item.Properties()).IsSwordGun().AddToList(RiderTabs.ZEZTZ_TAB_ITEM)
                    .ChangeRepairItem(CODE_CAPSEM.get()));
    ...
    public static final DeferredItem<Item> TRIPLE_ZEZTZER = ITEMS.register("triple_zeztzer",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 9, -2F, new Item.Properties()).AddToList(RiderTabs.ZEZTZ_TAB_ITEM)
                    .ChangeRepairItem(CODE_CAPSEM.get()));
    ...
    public static final DeferredItem<Item> BREAKAM_BREAKER_SHOOT = ITEMS.register("breakam_breaker_shoot",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).AddToList(RiderTabs.ZEZTZ_TAB_ITEM)
                    .ChangeRepairItem(CODE_CAPSEM.get()));
