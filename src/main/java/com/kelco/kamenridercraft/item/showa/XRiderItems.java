...
public class XRiderItems {
    ...
    public static final DeferredItem<Item> RIDOL = ITEMS.register("ridol",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"x",RIDOL_CORE ,XHELMET,XCHESTPLATE,XLEGGINGS , new Item.Properties())
                    .HasAnSDForm().IsA1().Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.X_TAB_ITEM));
    ...
    public static final DeferredItem<Item> DARK_RIDOL = ITEMS.register("dark_ridol",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"dark_x",RIDOL_CORE ,XHELMET,XCHESTPLATE,XLEGGINGS , new Item.Properties()).Dont_show_belt_form_info()
                    .Override_belt_text("dark_ridol_belt").AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.X_TAB_ITEM));

    public static final DeferredItem<Item> FAKE_RIDOL = ITEMS.register("fake_ridol",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"fake_x",RIDOL_CORE ,XHELMET,XCHESTPLATE,XLEGGINGS , new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.X_TAB_ITEM));

    public static final DeferredItem<Item> APOLLOGIST_BELT = ITEMS.register("apollogeist_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"apollogeist",APOLLOGIST_CORE ,XHELMET,XCHESTPLATE,XLEGGINGS , new Item.Properties()).HasAnSDForm().has_basic_model().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.X_TAB_ITEM));
