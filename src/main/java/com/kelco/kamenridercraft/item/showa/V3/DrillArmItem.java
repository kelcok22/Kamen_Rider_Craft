...
public class DrillArmItem extends BasePickaxeItem implements GeoItem {
    ...
    @Override
    public boolean onEntitySwing(@NotNull ItemStack itemStack, LivingEntity entity, @NotNull InteractionHand hand) {
        if (entity.level() instanceof ServerLevel serverLevel) {
            triggerAnim(entity, GeoItem.getOrAssignId(itemStack, serverLevel), "Drilling", "drilling");
            swingTimer = 0;
            animationOn = true;
        }
    ...
    public void inventoryTick(ItemStack itemStack, Level level, Entity entity, int slotId, boolean isSelected) {
        ...
        if (!entity.level().isClientSide()) {
            ...
            if (animationOn) {
                ...
                stopTriggeredAnim(entity, GeoItem.getOrAssignId(itemStack, (ServerLevel) entity.level()), "Drilling", "drilling");
            }
        }
    }
