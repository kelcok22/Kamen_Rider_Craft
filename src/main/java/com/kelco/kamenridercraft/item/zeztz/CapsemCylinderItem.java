package com.kelco.kamenridercraft.item.zeztz;
...
public class CapsemCylinderItem extends BaseItem {
    private static final Component UNKNOWN_CONTENTS = Component.translatable("container.shulkerBox.unknownContents");

    public CapsemCylinderItem() {
        ...
        if (!world.isClientSide && entity instanceof ServerPlayer serverPlayer) {
            serverPlayer.openMenu(new MenuProvider() {
                ...
                public Component getDisplayName() {
                    return Component.translatable("container.kamenridercraft.capsem_cylinder");
                }
                ...
                public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                    ...
                    return new CapsemCylinderGuiMenu(id, inventory, packetBuffer,itemstack);
                }
            }, buf -> {
