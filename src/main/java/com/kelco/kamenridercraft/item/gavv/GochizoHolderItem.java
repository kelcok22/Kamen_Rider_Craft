...
import com.kelco.kamenridercraft.world.inventory.GochizoHolderGuiMenu;
        ...
        if (!world.isClientSide && entity instanceof ServerPlayer serverPlayer) {
            serverPlayer.openMenu(new MenuProvider() {
                ...
                public Component getDisplayName() {
                    return Component.literal("Gochizo Holder");
                }
                ...
                public AbstractContainerMenu createMenu(int id, Inventory inventory, Player player) {
                    ...
                    return new GochizoHolderGuiMenu(id, inventory, packetBuffer,itemstack);
                }
            }, buf -> {
