...
public class Revice_Rider_Items {
	...
	public static final DeferredItem<Item> GIFFARD_REX_VISTAMP = ITEMS.register("giffard_rex_vistamp",
        () -> new RiderFormChangeItem(new Item.Properties(),0,"_ultimate","revi","revice_driver_belt_g",
                ...
                new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 1,true,false),
                new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1,true,false),
                new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1,true,false)).addAlternative(GIFFARD_REX_VISTAMP_VICE.get()).AddToList(RiderTabs.REVICE_TAB_ITEM));
...
//
	...
	public static final DeferredItem<Item> ANOMALOCARIS_VISTAMP = ITEMS.register("anomalocaris_vistamp",
			() -> new RiderFormChangeItem(new Item.Properties(),0,"_anomalocaris","demons","demons_driver_belt",
					...
					.addNeedForm(SPIDER_VISTAMP.get(), 1).AddToList(VistampBar.PROTO_VISTAMP, 3).AddToList(RiderTabs.REVICE_TAB_ITEM));
	...
	public static final DeferredItem<Item> BUDDY_BUCKLE = ITEMS.register("vice_belt",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"vice",REX_VISTAMP_VICE ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));

	public static final DeferredItem<Item> TWO_SIDRIVER_LIVE = ITEMS.register("two_sidriver_live",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"live",BAT_VISTAMP ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
	public static final DeferredItem<Item> TWO_SIDRIVER_EVIL = ITEMS.register("two_sidriver_evil",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"evil",BAT_VISTAMP_EVIL ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));

	public static final DeferredItem<Item> LIBERA_DRIVER = ITEMS.register("libera_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"jeanne",COBRA_VISTAMP ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));

	public static final DeferredItem<Item> DEMONS_DRIVER = ITEMS.register("demons_driver",
			() -> new DemonsDriverItem(ArmorMaterials.DIAMOND,"demons",SPIDER_VISTAMP ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
    ...
    public static final DeferredItem<Item> DESTREAM_DRIVER = ITEMS.register("destream_driver",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"destream",HERCULES_VISTAMP ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
	...
	public static final DeferredItem<Item> CYCLOTRON_DRIVER = ITEMS.register("cyclotron_driver",
			...
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
	public static final DeferredItem<Item> CYCLOTRON_DRIVER_BREAK = ITEMS.register("cyclotron_driver_break",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND,"century",CYCLOTRON_DRIVER_CORE ,REVICE_HELMET, REVICE_CHESTPLATE,REVICE_LEGGINGS , new Item.Properties())
			.AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
    ...
    public static final DeferredItem<Item> OHINBUSTER_50 = ITEMS.register("ohin_buster_50",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).IsSwordGun().AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
    public static final DeferredItem<Item> GUNDEPHONE_50 = ITEMS.register("gun_de_phone_50",
            () -> new BaseBlasterItem(Tiers.DIAMOND, 3, -2.4F, new Item.Properties()).AddToTabList(RiderTabs.REVICE_TAB_ITEM).ChangeRepairItem(PROTO_VISTAMP.get()));
