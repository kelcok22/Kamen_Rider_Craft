...
public class Hibiki_Rider_Items {
    ...
    public static final DeferredItem<Item> HENSHIN_ONSA = ITEMS.register("henshin_onsa",
            ...
            }.IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM));//WehN PUrpLE fIrE pARTIcLEs
    ...
    public static final DeferredItem<Item> HENSHIN_ONSA_KURENAI = ITEMS.register("henshin_onsa_kurenai",
            ...
            }.IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM));//WehN RED FiRE pArTiClEs
    //:cryingummy:
    ...
    public static final DeferredItem<Item> HIBIKIDRIVER = ITEMS.register("hibikidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"hibiki",HENSHIN_ONSA ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    ...
    public static final DeferredItem<Item> DANKIDRIVER = ITEMS.register("dankidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"danki",HENSHIN_ONSA_DANKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> SABAKIDRIVER = ITEMS.register("sabakidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"sabaki",HENSHIN_KIGEN_SABAKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> SHUKIDRIVER = ITEMS.register("shukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"shuki",HENSHIN_KIGEN_SHUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> GOUKIDRIVER = ITEMS.register("goukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"gouki",HENSHIN_ONSA_GOUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> TOKIDRIVER = ITEMS.register("tokidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"touki",HENSHIN_ONIBUE_TOKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> SHOUKIDRIVER = ITEMS.register("shoukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"shouki",HENSHIN_ONIBUE_SHOUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    ...
    public static final DeferredItem<Item> KABUKIDRIVER = ITEMS.register("kabukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"kabuki",HENSHIN_ONSA_KABUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> TOUKIDRIVER = ITEMS.register("toukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"touki_m",HENSHIN_ONSA_TOUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> KIRAMEKIDRIVER = ITEMS.register("kiramekidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"kirameki",HENSHIN_ONSA_KIRAMEKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> NISHIKIDRIVER = ITEMS.register("nishikidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"nishiki",HENSHIN_ONSA_NISHIKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> HABATAKIDRIVER = ITEMS.register("habatakidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"habataki",HENSHIN_ONSA_HABATAKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> FUBUKIDRIVER = ITEMS.register("fubukidriver",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"fubuki",HENSHIN_ONIBUE_FUBUKI ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
    public static final DeferredItem<Item> ARMOR_OF_THE_OGRE_BELT = ITEMS.register("armor_of_the_ogre_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"armor_of_the_ogre",ARMOR_OF_THE_OGRE ,HIBIKIHELMET,HIBIKICHESTPLATE,HIBIKILEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.HIBIKI_TAB_ITEM).ChangeRepairItem(ONI_ORE.get()));
