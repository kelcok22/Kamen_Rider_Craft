...
public class Blade_Rider_Items {
	...
	public static final DeferredItem<Item> EVOLUTION_CAUCASUS = ITEMS.register("evolution_caucasus",
			...
			}.IsGlowing().addNeedItem(ROUZE_ABSORBER.get()).addNeedItem(ABSORB_CAPRICORN.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));
	...
	public static final DeferredItem<Item> FUSION_PEACOCK = ITEMS.register("fusion_peacock",
			...
			}.IsGlowing().addNeedItem(ROUZE_ABSORBER.get()).HasCape().hasFlyingWings("garren_jack_wing.geo.json").AddToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));
	...
	public static final DeferredItem<Item> EVOLUTION_GIRAFFA = ITEMS.register("evolution_giraffa",
			...
			}.IsGlowing().addNeedItem(ROUZE_ABSORBER.get()).addNeedItem(ABSORB_SERPENT.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));
	...
	public static final DeferredItem<Item> GLAIVEBUCKLE = ITEMS.register("glaive_buckle",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "glaive", CHANGE_KERBEROS_GLAIVE, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> LANCEBUCKLE = ITEMS.register("lance_buckle",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "lance", CHANGE_KERBEROS_LANCE, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> LARCBUCKLE = ITEMS.register("larc_buckle",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "larc", CHANGE_KERBEROS_LARC, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> BLACK_JOKERROUZER = ITEMS.register("black_jokerrouzer",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "black_joker", BLACK_JOKER_SEALED, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> ALBINO_JOKERROUZER = ITEMS.register("albino_jokerrouzer",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "albino_joker", ALBINO_JOKER_SEALED, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> TAIYAKI_SECRET_WEAPON = ITEMS.register("taiyaki_secret_weapon",
			() -> new RiderDriverItem(ArmorMaterials.DIAMOND, "taiyaki_master" ,TAIYAKI_MASTER, BLADEHELMET, BLADECHESTPLATE, BLADELEGGINGS, new Item.Properties())
					.Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> CAUCASUS_SOLID_SHIELD = ITEMS.register("caucasus_solid_shield",
			() -> new BaseShieldItem(new Item.Properties()).AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).ChangeRepairItem(BLADECARD.get()));
