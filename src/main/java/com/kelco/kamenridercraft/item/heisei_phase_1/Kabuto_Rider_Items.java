...
public class Kabuto_Rider_Items {
    ...
    public static final DeferredItem<Item> KABUTO_ZECTER = ITEMS.register("kabuto_zecter",
            ...
            }.IsGlowing().addSwitchForm(KABUTO_ZECTER_MASK.get()).AddToList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM));
    ...
    public static final DeferredItem<Item> KICKHOPPER_RIDER_BELT = ITEMS.register("kickhopper_rider_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"kickhopper",KICKHOPPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    public static final DeferredItem<Item> PUNCHHOPPER_RIDER_BELT = ITEMS.register("puchhopper_rider_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"punchhopper",PUNCHHOPPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    ...
    public static final DeferredItem<Item> ZECTROOPER_BELT = ITEMS.register("zectrooper_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"zectrooper",ZECTROOPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    public static final DeferredItem<Item> SHADOW_TROOPER_BELT = ITEMS.register("shadow_trooper_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"shadow_trooper",ZECTROOPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    public static final DeferredItem<Item> BRIGHTROOPER_BELT = ITEMS.register("brightrooper_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"brightrooper",BRIGHTROOPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    public static final DeferredItem<Item> NEOTROOPER_BELT = ITEMS.register("neotrooper_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"neotrooper",NEOTROOPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()));
    public static final DeferredItem<Item> CHOPHOPPER_RIDER_BELT = ITEMS.register("chophopper_rider_belt",
            () -> new RiderDriverItem(ArmorMaterials.DIAMOND,"chophopper",CHOPHOPPER_ZECTER ,KABUTOHELMET,KABUTOCHESTPLATE,KABUTOLEGGINGS, new Item.Properties()).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KABUTO_TAB_ITEM).ChangeRepairItem(MINI_ZECTER.get()).has_basic_model());
