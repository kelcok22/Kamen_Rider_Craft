...
public class Kuuga_Rider_Items {
	...
	public static final DeferredItem<Item> PEGASUS_BOWGUN = ITEMS.register("pegasus_bowgun",
			() -> new NeoBaseBlasterItem(new Item.Properties(), -4F, -2.4F, true, 15F, 5, 1, 60, 30).setRequiresDraw(60, true).setProjectile("spectral_arrow").setParticles("", "smoke").setRepairItem(KUUGA_GROWING.get()).AddToList(KamenRiderCraftCore.KUUGA_CHANGING_ITEM).AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
