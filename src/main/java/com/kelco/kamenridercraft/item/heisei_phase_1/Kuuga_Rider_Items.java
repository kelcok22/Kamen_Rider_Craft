...
public class Kuuga_Rider_Items {
	...
	public static final DeferredItem<Item> KUUGA_MIGHTY = ITEMS.register("kuuga_mighty",
			...
			}.allowRiderKick().IsBeltGlowing().IsGlowing().IsBeltGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> KUUGA_RISING_MIGHTY = ITEMS.register("kuuga_rising_mighty",
			...
			}.allowRiderKick().IsBeltGlowing().IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> KUUGA_ULTIMATE_BLACK_EYES = ITEMS.register("kuuga_ultimate_black_eyes",
			...
			}.allowRiderKick().has_basic_model().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> KUUGA_RISING_ULTIMATE = ITEMS.register("kuuga_rising_ultimate",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"_rising_ultimate","kuuga","arcle_belt_ru",
				...
				public void OnTransformation(ItemStack itemstack, LivingEntity player) {
					...
					.allowRiderKick().IsGlowing().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> KUUGA_BLACK_RISING_MIGHTY = ITEMS.register("kuuga_black_rising_mighty",
			...
			}.allowRiderKick().IsBeltGlowing().IsGlowing().has_basic_model().model_has_different_name("kuuga_amazing_mighty").AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> KUUGA_TOUMA = ITEMS.register("kuuga_touma",
			...
			}.allowRiderKick().IsBeltGlowing().IsGlowing().IsBeltGlowing().has_basic_model().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> N_DAGUVA_ZEBA = ITEMS.register("n_daguva_zeba_ultimate",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE),"","n_daguva_zeba","n_daguva_zeba_belt_belt",
					...
					new MobEffectInstance(EffectCore.PUNCH, 40, 5,true,false),
					new MobEffectInstance(EffectCore.FIRE_ARMOR, 40, 5,true,false),
					new MobEffectInstance(EffectCore.FIRE_PUNCH, 40, 5,true,false),
					new MobEffectInstance(MobEffects.FIRE_RESISTANCE, 40, 0,true,false)) {
				public void OnTransformation(ItemStack itemstack, LivingEntity player) {
					super.OnTransformation(itemstack, player);
					((ServerLevel) player.level()).sendParticles(ModParticles.WHITE_SPARK_PARTICLES.get(),
			...
			}.has_basic_model().AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
	...
	public static final DeferredItem<Item> N_DAGUVA_ZEBA_BELT = ITEMS.register("n_daguva_zeba_belt",
			...
			).Dont_show_belt_form_info().AddToTabList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM).has_basic_model().ChangeRepairItem(KUUGA_GROWING.get()));
	...
	public static final DeferredItem<Item> PEGASUS_BOWGUN = ITEMS.register("pegasus_bowgun",
			() -> new NeoBaseBlasterItem(new Item.Properties(), -4F, -2.4F, true, 15F, 5, 1, 60, 30).setProjectile("spectral_arrow").setRequiresDraw(60, true).setParticles("warped", "smoke").setRepairItem(KUUGA_GROWING.get()).AddToList(KamenRiderCraftCore.KUUGA_CHANGING_ITEM).AddToList(KamenRiderCraftCore.CreativeTabRegistry.KUUGA_TAB_ITEM));
