...
public class BladeRiderItems {
    ...
    public static final DeferredItem<Item> SEALABLE_FUSION_EAGLE = ITEMS.register("sealable_fusion_eagle",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_eagle", "undead", "sealable_undead_buckle_royal_belt",
    ...
    public static final DeferredItem<Item> FUSION_EAGLE_UNDEAD = ITEMS.register("fusion_eagle_undead",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_eagle", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2, true, false),
    ...
    public static final DeferredItem<Item> ABSORB_CAPRICORN = ITEMS.register("absorb_capricorn",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_capricorn", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)) {
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> EVOLUTION_CAUCASUS_UNDEAD = ITEMS.register("evolution_caucasus_undead",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE), "_caucasus", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
    ...
    public static final DeferredItem<Item> SEALABLE_FUSION_PEACOCK = ITEMS.register("sealable_fusion_peacock",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_peacock", "undead", "sealable_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
    ...
    public static final DeferredItem<Item> FUSION_PEACOCK_UNDEAD = ITEMS.register("fusion_peacock_undead",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_peacock", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
    ...
    public static final DeferredItem<Item> FUSION_PEACOCK = ITEMS.register("fusion_peacock",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON).rarity(Rarity.UNCOMMON), "_jack", "garren", "garren_buckle_jack_belt",
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false),
    ...
    public static final DeferredItem<Item> ABSORB_SERPENT = ITEMS.register("absorb_serpent",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_serpent", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)) {
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> EVOLUTION_GIRAFFA_UNDEAD = ITEMS.register("evolution_giraffa_undead",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE), "_giraffa", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
    ...
    public static final DeferredItem<Item> EVOLUTION_GIRAFFA = ITEMS.register("evolution_giraffa",
            () -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE), "_king", "garren", "garren_buckle_king_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
    ...
    public static final DeferredItem<Item> SEALABLE_SHUFFLE_CENTIPEDE = ITEMS.register("sealable_shuffle_centipede",
            ...
            }.useBasicModel().setModelName("shuffle_centipede"));
