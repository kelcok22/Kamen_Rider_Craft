...
public class BladeRiderItems {
	...
	public static final DeferredItem<Item> SEALABLE_KICK_LOCUST = ITEMS.register("sealable_kick_locust",
			...
			}.useBasicModel().setModelName("kick_locust"));
	...
	public static final DeferredItem<Item> SEALABLE_THUNDER_DEER = ITEMS.register("sealable_thunder_deer",
			...
			}.useBasicModel().setModelName("thunder_deer"));
    ...
    public static final DeferredItem<Item> SEALABLE_MACH_JAGUAR = ITEMS.register("sealable_mach_jaguar",
            () -> new RiderFormChangeItem(new Item.Properties(), "_jaguar", "undead", "sealable_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
            ...
            }.useBasicModel().setModelName("mach_jaguar"));

    public static final DeferredItem<Item> MACH_JAGUAR = ITEMS.register("mach_jaguar",
            () -> new RiderFormChangeItem(new Item.Properties(), "_jaguar", "undead", "unsealed_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
	...
	public static final DeferredItem<Item> SEALABLE_FUSION_EAGLE= ITEMS.register("sealable_fusion_eagle",
			() -> new RiderFormChangeItem(new Item.Properties(), "_eagle", "undead", "sealable_undead_buckle_royal_belt",
			...
			}.useBasicModel().setModelName("fusion_eagle"));

	public static final DeferredItem<Item> FUSION_EAGLE_UNDEAD = ITEMS.register("fusion_eagle_undead",
			() -> new RiderFormChangeItem(new Item.Properties(), "_eagle", "undead", "unsealed_undead_buckle_royal_belt",
					new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false),
					new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 2, true, false),
			...
			}.addSwitchForm(SEALABLE_FUSION_EAGLE.get()).useBasicModel().setModelName("fusion_eagle"));
	...
	public static final DeferredItem<Item> FUSION_EAGLE = ITEMS.register("fusion_eagle",
			...
			}.isGlowing().addAlternative(FUSION_EAGLE_UNDEAD.get()).addNeedItem(ROUZE_ABSORBER.get()).hasCape().hasFlyingWings("blade_jack_wing.geo.json").addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));

    public static final DeferredItem<Item> SEALABLE_ABSORB_CAPRICORN = ITEMS.register("sealable_absorb_capricorn",
            () -> new RiderFormChangeItem(new Item.Properties(), "_capricorn", "undead", "sealable_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
            ...
            }.useBasicModel().setModelName("absorb_capricorn"));

    public static final DeferredItem<Item> ABSORB_CAPRICORN = ITEMS.register("absorb_capricorn",
            () -> new RiderFormChangeItem(new Item.Properties(), "_capricorn", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> SEALABLE_EVOLUTION_CAUCASUS= ITEMS.register("sealable_evolution_caucasus",
            () -> new RiderFormChangeItem(new Item.Properties(), "_caucasus", "undead", "sealable_undead_buckle_royal_belt",
            ...
            }.useBasicModel().setModelName("evolution_caucasus"));

    public static final DeferredItem<Item> EVOLUTION_CAUCASUS_UNDEAD = ITEMS.register("evolution_caucasus_undead",
            () -> new RiderFormChangeItem(new Item.Properties(), "_caucasus", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
            ...
            }.addSwitchForm(SEALABLE_EVOLUTION_CAUCASUS.get()).useBasicModel().setModelName("evolution_caucasus"));

    public static final DeferredItem<Item> EVOLUTION_CAUCASUS = ITEMS.register("evolution_caucasus",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.RARE), "_king", "blade", "blay_buckle_king_belt",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
					new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
					new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)) {
			...
			}.isGlowing().addAlternative(EVOLUTION_CAUCASUS_UNDEAD.get()).addNeedItem(ROUZE_ABSORBER.get()).addNeedItem(ABSORB_CAPRICORN.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));
    ...
    public static final DeferredItem<Item> SEALABLE_RAPID_PECKER = ITEMS.register("sealable_rapid_pecker",
            () -> new RiderFormChangeItem(new Item.Properties(), "_pecker", "undead", "sealable_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
            ...
            }.useBasicModel().setModelName("rapid_pecker"));

    public static final DeferredItem<Item> RAPID_PECKER = ITEMS.register("rapid_pecker",
            () -> new RiderFormChangeItem(new Item.Properties(), "_pecker", "undead", "unsealed_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> SEALABLE_ROCK_TORTOISE = ITEMS.register("sealable_rock_tortoise",
            () -> new RiderFormChangeItem(new Item.Properties(), "_tortoise", "undead", "sealable_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
            ...
            }.useBasicModel().setModelName("rock_tortoise"));

    public static final DeferredItem<Item> ROCK_TORTOISE = ITEMS.register("rock_tortoise",
            () -> new RiderFormChangeItem(new Item.Properties(), "_tortoise", "undead", "unsealed_undead_buckle_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> SEALABLE_SCOPE_BAT = ITEMS.register("sealable_scope_bat",
            () -> new RiderFormChangeItem(new Item.Properties(), "_bat", "undead", "sealable_undead_buckle_belt",
            ...
            }.useBasicModel().setModelName("scope_bat"));

    public static final DeferredItem<Item> SCOPE_BAT = ITEMS.register("scope_bat",
            () -> new RiderFormChangeItem(new Item.Properties(), "_bat", "undead", "unsealed_undead_buckle_belt",
                    new MobEffectInstance(EffectCore.GLIDE, 40, 0, true, false),
                    new MobEffectInstance(EffectCore.RADAR, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> SEALABLE_FUSION_PEACOCK= ITEMS.register("sealable_fusion_peacock",
            () -> new RiderFormChangeItem(new Item.Properties(), "_peacock", "undead", "sealable_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
            ...
            }.useBasicModel().setModelName("fusion_peacock"));

    public static final DeferredItem<Item> FUSION_PEACOCK_UNDEAD = ITEMS.register("fusion_peacock_undead",
            () -> new RiderFormChangeItem(new Item.Properties(), "_peacock", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
            ...
            }.addSwitchForm(SEALABLE_FUSION_PEACOCK.get()).useBasicModel().setModelName("fusion_peacock"));
    ...
    public static final DeferredItem<Item> SEALABLE_ABSORB_SERPENT = ITEMS.register("sealable_absorb_serpent",
            () -> new RiderFormChangeItem(new Item.Properties(), "_serpent", "undead", "sealable_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
            ...
            }.useBasicModel().setModelName("absorb_serpent"));

    public static final DeferredItem<Item> ABSORB_SERPENT = ITEMS.register("absorb_serpent",
            () -> new RiderFormChangeItem(new Item.Properties(), "_serpent", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 1, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
                public void transformationEffect(ItemStack itemstack, LivingEntity player) {
                    super.transformationEffect(itemstack, player);
    ...
    public static final DeferredItem<Item> SEALABLE_EVOLUTION_GIRAFFA= ITEMS.register("sealable_evolution_giraffa",
            () -> new RiderFormChangeItem(new Item.Properties(), "_giraffa", "undead", "sealable_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
            ...
            }.useBasicModel().setModelName("evolution_giraffa"));

    public static final DeferredItem<Item> EVOLUTION_GIRAFFA_UNDEAD = ITEMS.register("evolution_giraffa_undead",
            () -> new RiderFormChangeItem(new Item.Properties(), "_giraffa", "undead", "unsealed_undead_buckle_royal_belt",
                    new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
                    new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
                    new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
                    new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
            ...
            }.addSwitchForm(SEALABLE_EVOLUTION_GIRAFFA.get()).useBasicModel().setModelName("evolution_giraffa"));

	public static final DeferredItem<Item> EVOLUTION_GIRAFFA = ITEMS.register("evolution_giraffa",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_king", "garren", "garren_buckle_king_belt",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
					new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
					new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
	...
	public static final DeferredItem<Item> CHALICE_ROUZE_SPIRIT_STEVE = ITEMS.register("chalice_rouze_spirit_steve",
			...
			}.useBasicModel().setModelName("rouze_spirit"));

	public static final DeferredItem<Item> CHALICE_ROUZE_SPIRIT = ITEMS.register("chalice_rouze_spirit",
			() -> new RiderFormChangeItem(new Item.Properties(), "_human", "chalice", "chalice_rouzer_belt",
					new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 40, 0, true, false)){
				public void transformationEffect(ItemStack itemstack, LivingEntity player) {
					super.transformationEffect(itemstack, player);
					((ServerLevel) player.level()).sendParticles(ModParticles.GREEN_SPARK_PARTICLES.get(),
			...
			}.addSwitchForm(CHALICE_ROUZE_SPIRIT_STEVE.get()).useBasicModel().setModelName("rouze_spirit"));

	public static final DeferredItem<Item> SEALABLE_ROUZE_SPIRIT = ITEMS.register("sealable_rouze_spirit",
			() -> new RiderFormChangeItem(new Item.Properties(), "_human", "undead", "sealable_undead_buckle_belt",
	...
	public static final DeferredItem<Item> ROUZE_SPIRIT = ITEMS.register("rouze_spirit",
			() -> new RiderFormChangeItem(new Item.Properties(), "_human", "undead", "unsealed_undead_buckle_belt",
					new MobEffectInstance(MobEffects.HERO_OF_THE_VILLAGE, 40, 4, true, false)){
				public void transformationEffect(ItemStack itemstack, LivingEntity player) {
					super.transformationEffect(itemstack, player);
					((ServerLevel) player.level()).sendParticles(ModParticles.GREEN_SPARK_PARTICLES.get(),
			...
			}.addSwitchForm(SEALABLE_ROUZE_SPIRIT.get()).addAlternative(CHALICE_ROUZE_SPIRIT.get()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM));
	...
	public static final DeferredItem<Item> SEALABLE_FLOAT_DRAGONFLY = ITEMS.register("sealable_float_dragonfly",
			...
			}.useBasicModel().setModelName("float_dragonfly"));
...
public static final DeferredItem<Item> SEALABLE_REFLECT_MOTH = ITEMS.register("sealable_reflect_moth",
			...
			}.useBasicModel().setModelName("reflect_moth"));
...
public static final DeferredItem<Item> SEALABLE_SHUFFLE_CENTIPEDE = ITEMS.register("sealable_shuffle_centipede",
	...
	public static final DeferredItem<Item> EVOLUTION_PARADOXA = ITEMS.register("evolution_paradoxa",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_wild", "chalice", "chalice_rouzer_belt",
					new MobEffectInstance(MobEffects.DIG_SPEED, 40, 0, true, false),
	...
	public static final DeferredItem<Item> FUSION_ELEPHANT = ITEMS.register("fusion_elephant",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_jack", "leangle", "leangle_buckle_belt",
					new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1, true, false),
					new MobEffectInstance(MobEffects.MOVEMENT_SPEED, 40, 2, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 1, true, false)){
	...
	public static final DeferredItem<Item> EVOLUTION_TARANTULA = ITEMS.register("evolution_tarantula",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.UNCOMMON), "_king", "leangle", "leangle_buckle_king_belt",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
					new MobEffectInstance(MobEffects.JUMP, 40, 2, true, false),
					new MobEffectInstance(MobEffects.MOVEMENT_SLOWDOWN, 40, 0, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 4, true, false)){
	...
	public static final DeferredItem<Item> CHANGE_KERBEROS_GLAIVE = ITEMS.register("change_kerberos_glaive",
			() -> new RiderFormChangeItem(new Item.Properties(), "", "glaive", "glaive_buckle_belt",
					new MobEffectInstance(MobEffects.DIG_SPEED, 40, 1, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 0, true, false)){
				public void transformationEffect(ItemStack itemstack, LivingEntity player) {
					super.transformationEffect(itemstack, player);
	...
	public static final DeferredItem<Item> CHANGE_KERBEROS_LANCE = ITEMS.register("change_kerberos_lance",
			() -> new RiderFormChangeItem(new Item.Properties(), "", "lance", "lance_buckle_belt",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 0, true, false),
	...
	public static final DeferredItem<Item> CHANGE_KERBEROS_LARC = ITEMS.register("change_kerberos_larc",
			() -> new RiderFormChangeItem(new Item.Properties(), "", "larc", "larc_buckle_belt",
	...
	public static final DeferredItem<Item> BLACK_JOKER_SEALED = ITEMS.register("black_joker_sealed",
			() -> new RiderFormChangeItem(new Item.Properties().rarity(Rarity.EPIC), "", "black_joker", "black_jokerrouzer_belt",
					new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 40, 3, true, false),
					new MobEffectInstance(MobEffects.DAMAGE_BOOST, 40, 3, true, false)){
				public void transformationEffect(ItemStack itemstack, LivingEntity player) {
					super.transformationEffect(itemstack, player);
	...
	public static final DeferredItem<Item> LEANGLE_KINGROUZER = ITEMS.register("leangle_kingrouzer",
			() -> new BaseSwordItem(Tiers.DIAMOND, 7, -2.4F, new Item.Properties().rarity(Rarity.RARE)).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> GLAIVEROUZER = ITEMS.register("glaiverouzer",
			() -> new BaseSwordItem(Tiers.DIAMOND, 4, -2.4F, new Item.Properties()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> JAGUAR_CLAWS = ITEMS.register("jaguar_claws",
			() -> new BaseSwordItem(Tiers.DIAMOND, 3, -1.4F, new Item.Properties()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> CAPRICORN_CRESCENT_EDGE = ITEMS.register("capricorn_crescent_edge",
			() -> new BaseSwordItem(Tiers.DIAMOND, 9, -1.4F, new Item.Properties().rarity(Rarity.UNCOMMON)).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> CAUCASUS_ALL_OVER = ITEMS.register("caucasus_all_over",
			() -> new BaseSwordItem(Tiers.DIAMOND, 13, -2.4F, new Item.Properties().rarity(Rarity.RARE)).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> CAUCASUS_SOLID_SHIELD = ITEMS.register("caucasus_solid_shield",
			() -> new BaseShieldItem(new Item.Properties()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	public static final DeferredItem<Item> PEACOCK_SWORTHER = ITEMS.register("peacock_sworther",
			() -> new BaseSwordItem(Tiers.DIAMOND, 7, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON)).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
...
//			() -> new BaseSwordItem(Tiers.DIAMOND, 9, -2.4F, new Item.Properties().rarity(Rarity.UNCOMMON)).addToList(RiderTabs.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> JOKER_MANTIS = ITEMS.register("joker_mantis",
			() -> new BaseSwordItem(Tiers.DIAMOND, 19, -2.4F, new Item.Properties().rarity(Rarity.EPIC)).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
...
//			() -> new BaseShieldItem(new Item.Properties().rarity(Rarity.EPIC)).addToList(RiderTabs.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
//	public static final DeferredItem<Item> JASHIN_HEART_THUNDER = ITEMS.register("jashin_heart_thunder",
//			() -> new BaseBlasterItem(Tiers.DIAMOND, 13, -2.4F, new Item.Properties().rarity(Rarity.EPIC)).setProjectile(BaseBlasterItem.BlasterProjectile.SMALL_FIREBALL).addToList(RiderTabs.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
...
//			() -> new BaseSwordItem(Tiers.DIAMOND, 19, -2.4F, new Item.Properties().rarity(Rarity.EPIC)).addToList(RiderTabs.BLADE_TAB_ITEM).changeRepairItem(BLADECARD.get()));
	...
	public static final DeferredItem<Item> TAIYAKI_MOLD = ITEMS.register("taiyaki_mold",
			() -> new BaseSwordItem(Tiers.DIAMOND, 5, -2.4F, new Item.Properties()).addToList(KamenRiderCraftCore.CreativeTabRegistry.BLADE_TAB_ITEM).KeepItem().changeRepairItem(BLADECARD.get()));
