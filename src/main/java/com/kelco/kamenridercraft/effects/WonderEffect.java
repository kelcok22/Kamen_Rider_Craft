                    ...
                    if (stack.getItem() instanceof RiderDriverItem belt) {
                        if ( stack.has(DataComponents.CUSTOM_DATA)) {
                            ...
                            if (tag.getDouble("use_ability") != 0& pAmplifier != 2) {
                                int small= 0;
                                int big= 0;
                                if (player.hasEffect(EffectCore.SMALL))small=player.getEffect(EffectCore.SMALL).getAmplifier();
                                if (player.hasEffect(EffectCore.BIG))big=player.getEffect(EffectCore.BIG).getAmplifier();
                                ...
                                if (big>-1)player.addEffect(new MobEffectInstance(EffectCore.BIG, 120, big, false, false));
                                if (small>-1)player.addEffect(new MobEffectInstance(EffectCore.SMALL, 120, small, false, false));
