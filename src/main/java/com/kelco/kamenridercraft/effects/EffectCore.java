...
public class EffectCore {
    ...
    public static final Holder<MobEffect> NOTE = EFFECT.register("note",
            () -> new RamEffect.NoteEffect(MobEffectCategory.BENEFICIAL, 0x2d2d2d));

    public static final Holder<MobEffect> DRILL = EFFECT.register("drill",
            () -> new RamEffect.DrillEffect(MobEffectCategory.BENEFICIAL, 0xe5d90e));
    ...
    public static final Holder<MobEffect> WONDER = EFFECT.register("wonder",
            () -> new RamEffect.WonderEffect(MobEffectCategory.BENEFICIAL, 0x9d2cf3));
