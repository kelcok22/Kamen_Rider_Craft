...
public class EffectCore {
    ...
    public static final DeferredRegister<MobEffect> EFFECT = DeferredRegister.create(BuiltInRegistries.MOB_EFFECT, MOD_ID);

    public static final Holder<MobEffect> PUNCH = EFFECT.register("punch",
            () -> new PunchEffect(MobEffectCategory.BENEFICIAL, 0x1d8519)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.punch"), 1F, AttributeModifier.Operation.ADD_VALUE));

    public static final Holder<MobEffect> KNOCKBACK_BOOST = EFFECT.register("knockback_boost",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0x9d3443)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_KNOCKBACK, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.knockback_boost"), 0.2F, AttributeModifier.Operation.ADD_VALUE));


    public static final Holder<MobEffect> SLASH = EFFECT.register("slash",
            () -> new SlashEffect(MobEffectCategory.BENEFICIAL, 0x21daff)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.ATTACK_DAMAGE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.slash"), 1F, AttributeModifier.Operation.ADD_VALUE));
    ...
    public static final Holder<MobEffect> ELECTRIC_SHOCK = EFFECT.register("electric_shock",
            () -> new ElectricShockEffect(MobEffectCategory.HARMFUL, 0x76ecff));

    public static final Holder<MobEffect> ELECTRIC_PUNCH = EFFECT.register("electric_punch",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0x99D9EA));

    public static final Holder<MobEffect> ELECTRIC_SLASH = EFFECT.register("electric_slash",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0x99D9EA));

    public static final Holder<MobEffect> ELECTRIC_SHOT = EFFECT.register("electric_shot",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0x99D9EA));


    public static final Holder<MobEffect> POISON_PUNCH = EFFECT.register("poison_punch",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 8889187));

    public static final Holder<MobEffect> POISON_SLASH = EFFECT.register("poison_slash",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 8889187));

    public static final Holder<MobEffect> POISON_SHOT = EFFECT.register("poison_shot",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 8889187));
    ...
    public static final Holder<MobEffect> WITHER_PUNCH = EFFECT.register("wither_punch",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 7561558));

    public static final Holder<MobEffect> WITHER_SLASH = EFFECT.register("wither_slash",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 7561558));

    public static final Holder<MobEffect> WITHER_SHOT = EFFECT.register("wither_shot",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 7561558));
    ...
    public static final Holder<MobEffect> FLYING = EFFECT.register("flying",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0xffffff)
                    .addAttributeModifier(NeoForgeMod.CREATIVE_FLIGHT, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.flying"), 1F, AttributeModifier.Operation.ADD_VALUE));
    ...
    public static final Holder<MobEffect> STEP = EFFECT.register("step",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0x9d3443)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.STEP_HEIGHT, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.step"), 1F, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final Holder<MobEffect> GRAVITY = EFFECT.register("gravity",
            () -> new BasicEffect(MobEffectCategory.NEUTRAL, 0x1d8519)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.GRAVITY, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.gravity"), 1F, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final Holder<MobEffect> LONG_ARM = EFFECT.register("long_arm",
            () -> new BasicEffect(MobEffectCategory.BENEFICIAL, 0xe60052)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.BLOCK_INTERACTION_RANGE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.long_arm"), 1F, AttributeModifier.Operation.ADD_VALUE));

    public static final Holder<MobEffect> RADAR = EFFECT.register("radar",
            () -> new RadarEffect(MobEffectCategory.BENEFICIAL, 0x1d8519));
    ...
    public static final Holder<MobEffect> SMALL = EFFECT.register("small",
            () -> new BasicEffect(MobEffectCategory.NEUTRAL, 0x1d8519)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.SCALE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.small"), -0.1F, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));

    public static final Holder<MobEffect> BIG = EFFECT.register("big",
            () -> new BasicEffect(MobEffectCategory.NEUTRAL, 0x1d8519)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.SCALE, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.big"), 1F, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL));
    ...
    public static final Holder<MobEffect> SLEEP = EFFECT.register("sleep",
            () -> new SleepEffect(MobEffectCategory.BENEFICIAL, 0xffce00));

    public static final Holder<MobEffect> NIGHT = EFFECT.register("night",
            () -> new NightEffect(MobEffectCategory.NEUTRAL, 0xffed9e));
    ...
    public static final Holder<MobEffect> SMELL = EFFECT.register("smell",
            () -> new SmellEffect(MobEffectCategory.NEUTRAL, 0x853d1b));
    ...
    public static final Holder<MobEffect> DARK_AURA = EFFECT.register("dark_aura",
            () -> new DarkAuraEffect(MobEffectCategory.HARMFUL, 0x55FFFF));
    ...
    public static final Holder<MobEffect> PAUSE = EFFECT.register("pause",
            () -> new BasicEffect(MobEffectCategory.HARMFUL, 0x4eff00)
                    .addAttributeModifier(net.minecraft.world.entity.ai.attributes.Attributes.MOVEMENT_SPEED, ResourceLocation.fromNamespaceAndPath(MOD_ID, "effect.pause"), -100F, AttributeModifier.Operation.ADD_MULTIPLIED_TOTAL)
