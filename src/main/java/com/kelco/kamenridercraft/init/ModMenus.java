...
public class ModMenus {
    ...
    public static final Supplier<MenuType<AdventDeckGuiMenu>> ADVENT_DECK_GUI = REGISTRY.register("advent_deck_gui", () -> IMenuTypeExtension.create(AdventDeckGuiMenu::new));
    ...
    public static final DeferredHolder<MenuType<?>, MenuType<RoyalSwordOfLogosHolderGuiMenu>> ROYAL_SWORD_OF_LOGOS_HOLDER_GUI = REGISTRY.register("royal_sword_of_logos_holder_gui", () -> IMenuTypeExtension.create(RoyalSwordOfLogosHolderGuiMenu::new));
