...
public class BoostrikerBuffaModeEntity extends baseBikeEntity {
	public BoostrikerBuffaModeEntity(EntityType<? extends baseBikeEntity> entityType, Level level) {
		super(entityType, level, Geats_Rider_Items.BOOST_RAISE_BUCKLE.get());
		NAME ="boostriker_buffa_mode";
		NAME_MODEL ="boostriker_buffa_mode";
