...
public class UvaEntity extends BaseHenchmenEntity {


	
    public UvaEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="uva";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(OOO_Rider_Items.GREEED_BLET_UVA.get()));
    }
