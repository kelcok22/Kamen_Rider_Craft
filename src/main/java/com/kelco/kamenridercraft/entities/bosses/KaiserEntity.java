...
public class KaiserEntity extends BaseHenchmenEntity {

		public KaiserEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="kaiser";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Build_Rider_Items.NEBULA_STEAM_GUN_KAISER.get()));
            RiderDriverItem.set_Form_Item(this.getItemBySlot(EquipmentSlot.FEET), Build_Rider_Items.GEAR_REMOCON_BLUE.get(), 1);
    }
