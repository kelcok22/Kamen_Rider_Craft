...
public class TerrorDopantEntity extends BaseHenchmenEntity {


	
    public TerrorDopantEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="terror_dopant";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(W_Rider_Items.GAIA_DRIVER_TERROR.get()));
    }
