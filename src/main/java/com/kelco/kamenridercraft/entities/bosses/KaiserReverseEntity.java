...
public class KaiserReverseEntity extends BaseHenchmenEntity {

		public KaiserReverseEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="kaiser_reverse";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Build_Rider_Items.NEBULA_STEAM_GUN_KAISER.get()));
            RiderDriverItem.set_Form_Item(this.getItemBySlot(EquipmentSlot.FEET), Build_Rider_Items.GEAR_ENGINE_RED.get(), 1);
    }
