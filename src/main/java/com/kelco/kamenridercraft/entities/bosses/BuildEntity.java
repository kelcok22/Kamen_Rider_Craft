...
public class BuildEntity extends BaseHenchmenEntity {

		public BuildEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="build";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Build_Rider_Items.BUILD_DRIVER.get()));
    }
