...
public class ShockerGreeedEntity extends BaseHenchmenEntity {



	public ShockerGreeedEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="ankh_lost";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(OOO_Rider_Items.GREEED_BLET_SHOCKER.get()));
