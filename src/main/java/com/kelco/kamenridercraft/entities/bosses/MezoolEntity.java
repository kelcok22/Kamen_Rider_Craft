...
public class MezoolEntity extends BaseHenchmenEntity {


	
    public MezoolEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="mezool";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(OOO_Rider_Items.GREEED_BLET_MEZOOL.get()));
    }
