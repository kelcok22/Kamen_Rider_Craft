...
public class SigurdEntity extends BaseHenchmenEntity {
   
    public SigurdEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="sigurd";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Gaim_Rider_Items.GENESIS_DRIVER_SIGURD.get()));
