...
public class NDaguvaZebaEntity extends BaseHenchmenEntity {
    ...
    private static final EntityDataAccessor<Byte> DATA_FLAGS_ID = SynchedEntityData.defineId(NDaguvaZebaEntity.class, EntityDataSerializers.BYTE);
