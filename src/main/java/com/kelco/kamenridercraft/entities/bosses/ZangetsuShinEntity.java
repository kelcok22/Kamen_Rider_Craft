...
public class ZangetsuShinEntity extends BaseHenchmenEntity {
   
    public ZangetsuShinEntity(EntityType<? extends BaseHenchmenEntity> type, Level level) {
        super(type, level);
        NAME="zangetsu_shin";
        ...
        this.setItemSlot(EquipmentSlot.FEET, new ItemStack(Gaim_Rider_Items.GENESIS_DRIVER_ZANGETSU_SHIN.get()));
